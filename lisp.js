...
function process_input(in_str, state, cb) {
  var e = Parse.parse_single(in_str);
  if (e.tag) {
    ...
    return Curry._4(Evaluate.Eval[/* eval */12], e[0], Curry._1(Evaluate.Eval[/* create_initial_context */6], state), state, cb);
  }
}
...
var state = [Curry._1(Builtins[/* add_builtins */1], Evaluate.Eval[/* empty */0])];
...
input_element.onkeydown = function (e) {
  ...
  if (match >= 38) {
    ...
    position[0] = 0;
    process_input(in_str, state[0], function (param) {
          evaluating[0] = /* false */0;
          state[0] = param[1];
          input_element.value = "";
          add_console_element("> " + in_str);
          return add_console_element(Common.string_of_ast(param[0]));
        });
    return false;
  }
};
...
function Builtins(Environment) {
  var received_error = function (expected, args, name, state) {
    return /* tuple */[
            Common.create_exception("Received " + (Pervasives.string_of_int(List.length(args)) + (" arguments, expected " + (Pervasives.string_of_int(expected) + (" in call to '" + (name + "'")))))),
            state
          ];
  };
  var add_builtins = function (state) {
    var add_native_lambda = function (name, is_macro, func, state) {
      ...
      var node = Common.create_node(/* NativeFunc */Block.__(7, [/* record */[
                /* func */asyncf,
                /* is_macro */is_macro
              ]]));
      return Curry._3(Evaluate.Eval[/* define_native_symbol */7], state, name, node);
    };
      ...
      return add_native_lambda(op_name, /* false */0, function (args, _, state) {
                  ...
                  if (args) {
                    ...
                    if (hd.tag === 2) {
                            ...
                            if (acc.tag) {
                              ...
                              if (match.tag === 2) {
                                ...
                                if (match$1.tag === 2) {
                                  ...
                                  return Common.create_exception("Called '" + (op_name + "' with something not a number."));
                                }
                              } else {
                                return Common.create_exception("Called '" + (op_name + "' with something not a number."));
                              }
                      ...
                      $js = res.tag ? /* Error */Block.__(1, [res[0]]) : /* Ok */Block.__(0, [Common.create_node(res[0])]);
                    } else {
                      $js = Common.create_exception("Called '" + (op_name + "' with something not a number."));
                    }
                  } else {
                    $js = Common.create_exception("Called '" + (op_name + "' with no args."));
                  }
                  return /* tuple */[
                          $js,
                          state
    ...
    var create_lambda_scope = function (node, map, arg_names, ctx, state) {
      ...
      switch (match.tag | 0) {
        case 0 : 
            var i = match[0];
            var match$1 = Curry._3(Evaluate.Eval[/* resolve_ident */9], i, ctx, state);
            if (match$1) {
              var x = match$1[0];
              var new_state = Curry._2(Evaluate.Eval[/* add_to_uuid_map */11], state, x);
        ...
        if (match.tag === 5) {
          ...
          if (match$1) {
            if (match$1[1]) {
              ...
              if (arg_names.tag) {
                return /* tuple */[
                        Common.create_exception(arg_names[0]),
                        state
                      ];
              } else {
                ...
                if (match$3.tag) {
                  return /* tuple */[
                          Common.create_exception(match$3[0]),
                          state
                        ];
                } else {
                  ...
                  var new_state = Curry._2(Evaluate.Eval[/* add_to_uuid_map */11], match$4[1], node);
                  return /* tuple */[
                          /* Ok */Block.__(0, [node]),
                          new_state
                        ];
          ...
          if (args) {
            ...
            if (match) {
              if (match[1]) {
                ...
                var lambda = match[0];
                return Curry._4(Evaluate.Eval[/* eval */12], args[0], ctx, state, function (x) {
                            var match = x[0];
                            if (match.tag) {
                              var ex = match[0];
                              return Curry._4(Evaluate.Eval[/* eval */12], lambda, ctx, x[1], function (param) {
                                          var match = param[0];
                                          if (match.tag) {
                                            return Curry._1($$return, /* tuple */[
                                                        Common.create_exception("Expected lambda as second argument in call to 'try'"),
                                                        param[1]
                                                      ]);
                                          } else {
                                            var func = match[0];
                                            ...
                                            if (exit === 1) {
                                              return Curry._6(Evaluate.Eval[/* eval_lambda */13], func, /* :: */[
                                                          ex,
                                                          /* [] */0
    ...
    var state$9 = add_native_lambda_async("define", /* true */1, function (args, ctx, state, $$return) {
            ...
            if (match.tag) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  return Curry._1($$return, /* tuple */[
                              Common.create_exception("Expected ident as first argument in call to 'define'"),
                              state
                            ]);
                }
              } else {
          ...
          switch (exit) {
            ...
            case 2 : 
                ...
                if (ctx[/* depth */2] > 2) {
                  return Curry._1($$return, /* tuple */[
                              Common.create_exception("Can only define at the top level"),
                              state
                            ]);
                } else if (Curry._2(Evaluate.Eval[/* is_reserved_symbol */10], state, ident)) {
                  return Curry._4(Evaluate.Eval[/* eval */12], other, ctx, state, function (e) {
                              var match = e[0];
                              if (match.tag) {
                                ...
                                if (res[/* value */1].tag === 7) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              ...
                                              Curry._3(Evaluate.Eval[/* define_user_symbol */8], e[1], ident, res)
                                            ]);
                                }
                              }
                            });
                  ...
                  return Curry._1($$return, /* tuple */[
                              Common.create_exception("Cannot define reserved keyword [" + (ident + "].")),
                              state
                            ]);
                }
    ...
    var state$11 = add_native_lambda_async("unquote", /* true */1, function (args, ctx, state, $$return) {
          if (args) {
            if (args[1]) {
              ...
              return Curry._4(Evaluate.Eval[/* eval */12], args[0], ctx, state, $$return);
            }
          } else {
            return Curry._1($$return, received_error(1, args, "unquote", state));
          }
            ...
            if (match$2.tag) {
              ...
              if (match$3) {
                if (match$3[1]) {
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */12], match$3[0], ctx, state, function (param) {
                              var state = param[1];
                              var res = param[0];
                              if (res.tag) {
                                return Curry._1($$return, /* tuple */[
                                ...
                                if (match.tag === 5) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              Common.create_exception("'unquote-splice' only applies to lists"),
                                              state
                                            ]);
                                }
                              }
          ...
          if (match$1.tag) {
            ...
            if (lst$1) {
              if (lst$1[1]) {
                ...
                return Curry._4(Evaluate.Eval[/* eval */12], lst$1[0], ctx, state, $$return);
              }
            } else {
              return Curry._1($$return, received_error(1, lst$1, "unquote", state));
            }
        ...
        if (exit === 1) {
          return traverseH(lst, /* [] */0, ctx, state, function (param) {
                      ...
                      if (match.tag) {
                        ...
                        return Curry._1($$return, /* tuple */[
                                    /* Ok */Block.__(0, [Common.create_node(/* List */Block.__(5, [match[0]]))]),
                                    param[1]
                                  ]);
                      }
                    });
            ...
            if (match) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */12], args[0], ctx, state, function (evaled_cond) {
                              ...
                              if (match.tag) {
                                ...
                                if (match$1.tag === 3) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              Common.create_exception("First argument to 'if' must evaluate to boolean."),
                                              evaled_cond[1]
                                            ]);
                                }
                              }
    ...
    var eval_list = function (lst, state, ctx, $$return) {
      if (lst) {
        var tl = lst[1];
        return Curry._4(Evaluate.Eval[/* eval */12], lst[0], ctx, state, function (param) {
                    var match = param[0];
                    if (match.tag) {
                      return Curry._1($$return, /* Error */Block.__(1, [match[0]]));
                    } else {
                      var state = param[1];
                      return eval_list(tl, state, Curry._1(Evaluate.Eval[/* create_initial_context */6], state), $$return);
                    }
                  });
      } else {
            ...
            if (match.tag === 1) {
              if (args[1]) {
                ...
                return Curry._2(Environment[/* load_lib */0], lib_name, function (text) {
                            if (text) {
                              var match = Parse.parse_multi($$String.trim(text[0]));
                              if (match.tag) {
                                return Curry._1($$return, /* tuple */[
                                            /* Error */Block.__(1, [match[0]]),
                                            state
                              ...
                              return Curry._1($$return, /* tuple */[
                                          Common.create_exception("Could not load lib " + lib_name),
                                          state
                                        ]);
                            }
                          });
              ...
              return Curry._1($$return, /* tuple */[
                          Common.create_exception("Expected string as first argument in call to 'load'"),
                          state
                        ]);
            }
          } else {
          ...
          if (args) {
            ...
            if (match) {
              if (match[1]) {
                ...
                return /* tuple */[
                        /* Ok */Block.__(0, [Curry._1(Evaluate.Eval[/* to_bool_node */4], equal_helper(args[0], match[0]))]),
                        state
                      ];
              }
            } else {
          ...
          if (args) {
            ...
            if (match.tag === 6) {
              if (args[1]) {
                ...
                console.log(Common.string_of_stringmap(match[0][/* scope */3]));
                return /* tuple */[
                        /* Ok */Block.__(0, [Evaluate.Eval[/* empty_node */1]]),
                        state
                      ];
...
function stringmap_get(key, map) {
  try {
...
function stringmap_union(m1, m2) {
...
function string_of_ast(ast) {
  if (ast.tag) {
    return "[Exception of " + (string_of_ast(/* Ok */Block.__(0, [ast[0]])) + "]");
  } else {
    ...
    switch (match.tag | 0) {
      ...
      case 5 : 
          return "(" + ($$String.concat(" ", List.map(function (v) {
                            return string_of_ast(/* Ok */Block.__(0, [v]));
                          }, match[0])) + ")");
      case 6 : 
          var f = match[0];
          ...
          var body = string_of_ast(/* Ok */Block.__(0, [f[/* func */0]]));
...
var empty_000 = /* userTable */Common.StringMap[/* empty */0];

var empty_001 = /* symbolTable */Common.StringMap[/* empty */0];

var empty_002 = /* uuidToNodeMap */Common.StringMap[/* empty */0];
...
var empty_node_000 = /* uuid */Common.gen_uuid(/* () */0);

var empty_node_001 = /* value : List */Block.__(5, [/* [] */0]);

var empty_node = /* record */[
  empty_node_000,
  empty_node_001
];

var trueNode_000 = /* uuid */Common.gen_uuid(/* () */0);
...
var falseNode_000 = /* uuid */Common.gen_uuid(/* () */0);
...
function add_to_uuid_map(state, node) {
  return /* record */[
          ...
          /* uuidToNodeMap */Curry._3(Common.StringMap[/* add */3], node[/* uuid */0], node, state[/* uuidToNodeMap */2])
        ];
}

function is_reserved_symbol(state, ident_name) {
  return +(Common.stringmap_get(ident_name, state[/* symbolTable */1]) === /* None */0);
}

function define_native_symbol(state, ident_name, node) {
  return /* record */[
          /* userTable */state[/* userTable */0],
          /* symbolTable */Curry._3(Common.StringMap[/* add */3], ident_name, node[/* uuid */0], state[/* symbolTable */1]),
          /* uuidToNodeMap */Curry._3(Common.StringMap[/* add */3], node[/* uuid */0], node, state[/* uuidToNodeMap */2])
        ];
}
...
function define_user_symbol(state, ident_name, node) {
  return /* record */[
          /* userTable */Curry._3(Common.StringMap[/* add */3], ident_name, node[/* uuid */0], state[/* userTable */0]),
          /* symbolTable */state[/* symbolTable */1],
          /* uuidToNodeMap */Curry._3(Common.StringMap[/* add */3], node[/* uuid */0], node, state[/* uuidToNodeMap */2])
        ];
}
...
function resolve_ident(ident_name, ctx, state) {
  var uuid = Common.stringmap_get(ident_name, state[/* symbolTable */1]);
  var uuid$1 = uuid ? uuid : Common.stringmap_get(ident_name, ctx[/* argsTable */1]);
  if (uuid$1) {
    var x = uuid$1[0];
    var match = Common.stringmap_get(x, state[/* uuidToNodeMap */2]);
    if (match) {
      return /* Some */[match[0]];
    } else {
      var match$1 = Common.stringmap_get(x, ctx[/* argsUuidMap */0]);
      if (match$1) {
...
function create_lambda_arg_map(vararg, _func_args, _passed_args, _map) {
  while(true) {
    ...
    if (func_args) {
      ...
      if (exit === 1) {
        if (vararg) {
          return /* Ok */Block.__(0, [Curry._3(Common.StringMap[/* add */3], vararg[0], /* record */[
                          /* uuid */Common.gen_uuid(/* () */0),
                          /* value : List */Block.__(5, [passed_args])
                        ], map)]);
        } else {
    ...
    switch (value.tag | 0) {
      case 0 : 
          ...
          if (match) {
            ...
            return Curry._1(cb, /* tuple */[
                        Common.create_exception("Undeclared identifier [" + (ident + "].")),
                        state
                      ]);
          }
      case 5 : 
...
function eval_lambda(called_func, args, _, ctx, state, cb) {
  var func_value = called_func[/* value */1];
  if (ctx[/* depth */2] > 512) {
    return Curry._1(cb, /* tuple */[
                Common.create_exception("Stack overflow > " + Pervasives.string_of_int(512)),
                state
              ]);
  } else {
                  ...
                  case 6 : 
                      ...
                      if (match.tag) {
                        ...
                        if (arg_to_node_map.tag) {
                          return Curry._1(cb, /* tuple */[
                                      Common.create_exception(arg_to_node_map[0]),
                                      state
                                    ]);
                        } else {
                          ...
                          var argsTable = Common.stringmap_union(arg_map, match$1[/* scope */3]);
                      ...
                      break;
                  case 7 : 
                      var match$2 = maybe_args[0];
                      if (match$2.tag) {
                        return Curry._1(cb, maybe_args);
                      } else {
                        return Curry._4(func_value[0][/* func */0], match$2[0], /* record */[
    ...
    if (match) {
      ...
      if (c !== 34) {
        ...
        return /* ParseOk */Block.__(0, [/* tuple */[
                    pop(stream),
                    Common.create_node(/* Str */Block.__(1, [acc]))
                  ]]);
      }
    } else {
      return /* ParseFail */Block.__(1, ["Unterminated string."]);
    ...
    if (exit === 1) {
      switch (acc) {
        ...
        case "false" : 
            return /* ParseOk */Block.__(0, [/* tuple */[
                        stream,
                        Evaluate.Eval[/* falseNode */3]
                      ]]);
        case "true" : 
            return /* ParseOk */Block.__(0, [/* tuple */[
                        stream,
                        Evaluate.Eval[/* trueNode */2]
                      ]]);
        default:
          return /* ParseOk */Block.__(0, [/* tuple */[
                      stream,
                      Common.create_node(/* Ident */Block.__(0, [acc]))
                    ]]);
      }
    }
  ...
  while(true) {
    ...
    if (exit === 1) {
      ...
      if (num) {
        return /* ParseOk */Block.__(0, [/* tuple */[
                    stream,
                    Common.create_node(/* Num */Block.__(2, [num[0]]))
                  ]]);
      } else {
  ...
  while(true) {
    ...
    if (match) {
      ...
      if (typeof match$1 === "number") {
        return Common.create_exception("Unexpected end of input.");
      } else if (match$1.tag) {
        return Common.create_exception(match$1[0]);
      } else {
