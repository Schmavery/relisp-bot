...
function process_input(state, cb, in_str) {
  ...
  if (e.tag) {
    ...
    return Curry._4(Evaluate.Eval[/* eval */8], e[0], Curry._1(Evaluate.Eval[/* create_initial_context */2], state), state, cb);
  }
}
...
},{"../../src/builtinFuncs.js":2,"../../src/common.js":3,"../../src/evaluate.js":4,"../../src/parse.js":5,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/random.js":38}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function Builtins(Environment) {
  ...
  var add_builtins = function (state) {
    var add_native_lambda = function (name, is_macro, func, state) {
      ...
      return Curry._3(Evaluate.Eval[/* define_native_symbol */3], state, name, node);
    };
    ...
    var create_lambda_scope = function (node, map, arg_names, ctx, state) {
      switch (node.tag | 0) {
        case 0 : 
            var i = node[0];
            var match = Curry._3(Evaluate.Eval[/* resolve_ident */5], i, ctx, state);
            if (match) {
              var node$1 = match[0];
              if (node$1.tag === 7) {
                ...
                var new_state = Curry._3(Evaluate.Eval[/* add_to_uuid_map */7], state, hash, node$1);
                return /* Ok */Block.__(0, [/* tuple */[
                            Curry._3(Common.StringMap[/* add */3], i, hash, map),
                            new_state
                          ]]);
              }
            } else {
            ...
            if (match$1[1]) {
              ...
              if (arg_names.tag) {
                ...
                if (match$3.tag) {
                  ...
                  var new_state = Curry._3(Evaluate.Eval[/* add_to_uuid_map */7], match$4[1], hash, node);
                  return /* tuple */[
                          /* Ok */Block.__(0, [node]),
                          new_state
                        ];
          ...
          if (args) {
            ...
            if (match) {
              if (match[1]) {
                ...
                var lambda = match[0];
                return Curry._4(Evaluate.Eval[/* eval */8], args[0], ctx, state, function (x) {
                            var match = x[0];
                            if (match.tag) {
                              var ex = match[0][1];
                              return Curry._4(Evaluate.Eval[/* eval */8], lambda, ctx, x[1], function (param) {
                                          var match = param[0];
                                          var exit = 0;
                                          if (match.tag) {
                                            exit = 1;
                                            ...
                                            if (exit$1 === 2) {
                                              return Curry._6(Evaluate.Eval[/* eval_lambda */9], func, /* :: */[
                                                          ex,
                                                          /* [] */0
    ...
    var state$9 = add_native_lambda_async("define", /* true */1, function (args, ctx, state, $$return) {
          ...
          switch (exit) {
            ...
            case 2 : 
                ...
                } else if (Curry._2(Evaluate.Eval[/* is_reserved_symbol */6], state, ident)) {
                  return Curry._4(Evaluate.Eval[/* eval */8], other, ctx, state, function (e) {
                              var match = e[0];
                              if (match.tag) {
                                ...
                                if (res.tag === 7) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              ...
                                              Curry._3(Evaluate.Eval[/* define_user_symbol */4], e[1], ident, res)
                                            ]);
                                }
                              }
                            });
    ...
    var state$11 = add_native_lambda_async("unquote", /* true */1, function (args, ctx, state, $$return) {
          if (args) {
            if (args[1]) {
              ...
              return Curry._4(Evaluate.Eval[/* eval */8], args[0], ctx, state, $$return);
            }
          } else {
            return Curry._1($$return, received_error(1, args, "unquote", state));
          }
            ...
            if (match$1.tag) {
              ...
              if (match$2) {
                if (match$2[1]) {
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */8], match$2[0], ctx, state, function (param) {
                              var state = param[1];
                              var res = param[0];
                              if (res.tag) {
                                return Curry._1($$return, /* tuple */[
          ...
          if (match.tag) {
            ...
            if (lst$1) {
              if (lst$1[1]) {
                ...
                return Curry._4(Evaluate.Eval[/* eval */8], lst$1[0], ctx, state, $$return);
              }
            } else {
              return Curry._1($$return, received_error(1, lst$1, "unquote", state));
            }
            ...
            if (match) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */8], args[0], ctx, state, function (evaled_cond) {
    ...
    var eval_list = function (lst, state, ctx, $$return) {
      if (lst) {
        var tl = lst[1];
        return Curry._4(Evaluate.Eval[/* eval */8], lst[0], ctx, state, function (param) {
                    var match = param[0];
                    if (match.tag) {
                  ...
                  if (match.tag === 5) {
                    ...
                    if (match$1) {
                      if (args[1]) {
                        ...
                        return Curry._4(Evaluate.Eval[/* eval */8], match$1[0], ctx, initial_state, function (param) {
                                    ...
                                    if (exit === 1) {
                                      return Curry._6(Evaluate.Eval[/* eval_lambda */9], func, args$1, "expand", ctx, param[1], cb);
                                    }
...
},{"./common.js":3,"./evaluate.js":4,"./parse.js":5,"bs-platform/lib/js/block.js":7,"bs-platform/lib/js/caml_builtin_exceptions.js":11,"bs-platform/lib/js/caml_obj.js":21,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/js_exn.js":32,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/pervasives.js":36,"bs-platform/lib/js/string.js":39}],3:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function to_string$1(state) {
  return "====state====\nuserTable:\n" + (to_string(state[/* userTable */0]) + ("-------------\nsymbolTable:\n" + Curry._3(StringMap[/* fold */10], function (k, _, a) {
                  return a + (k + "\n");
                }, state[/* symbolTable */1], "")));
}
...
function to_hashstring(ast) {
  switch (ast.tag | 0) {
    ...
    case 6 : 
        ...
        var scope_list = Curry._3(StringMap[/* fold */10], function (k, v, a) {
              return /* :: */[
                      k + v,
                      a
                    ];
...
},{"bs-platform/lib/js/block.js":7,"bs-platform/lib/js/caml_string.js":22,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/map.js":34,"bs-platform/lib/js/pervasives.js":36,"bs-platform/lib/js/printf.js":37,"bs-platform/lib/js/string.js":39}],4:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function wrap_in_uuid(uuid) {
  return /* Uuid */Block.__(0, [uuid]);
}
...
function define_native_symbol(state, ident_name, node) {
  return Curry._3(Common.EvalState[/* add_to_symboltable */3], ident_name, node, state);
}
...
function define_user_symbol(state, ident_name, node) {
  ...
  return Curry._3(Common.EvalState[/* add_to_usertable */4], ident_name, uuid, state$1);
}
...
function resolve_ident(ident_name, ctx, state) {
  ...
  if (match) {
    ...
    if (match$1) {
      var match$2 = match$1[0];
      if (match$2.tag) {
        return /* Some */[match$2[0]];
      } else {
        var match$3 = Curry._2(Common.StringMapHelper[/* get */0], match$2[0], state[/* uuidToNodeMap */2]);
        if (match$3) {
                  ...
                  case 6 : 
                      ...
                      if (match.tag) {
                        ...
                        if (arg_to_node_map.tag) {
                          ...
                          var scope_map$1 = Curry._3(Common.StringMap[/* add */3], "recur", /* Uuid */Block.__(0, [match$1[/* recur */4]]), scope_map);
                          var argsTable = Curry._2(Common.StringMapHelper[/* union */1], arg_to_node_map[0], scope_map$1);
...
},{"./common.js":3,"bs-platform/lib/js/block.js":7,"bs-platform/lib/js/caml_builtin_exceptions.js":11,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/pervasives.js":36}],5:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
},{"./common.js":3,"bs-platform/lib/js/block.js":7,"bs-platform/lib/js/caml_builtin_exceptions.js":11,"bs-platform/lib/js/caml_format.js":15,"bs-platform/lib/js/caml_string.js":22,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/string.js":39}],6:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":10,"./caml_builtin_exceptions.js":11,"./caml_exceptions.js":13,"./curry.js":28,"./js_exn.js":32}],7:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":9,"./caml_builtin_exceptions.js":11,"./caml_string.js":22,"./curry.js":28,"./pervasives.js":36,"./string.js":39,"./sys.js":40}],9:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./caml_int32.js":16,"./caml_obj.js":21,"./caml_string.js":22,"./char.js":27,"./curry.js":28,"./list.js":33,"./pervasives.js":36}],10:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11}],11:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11}],13:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./caml_int32.js":16,"./caml_int64.js":17,"./caml_utils.js":24,"./curry.js":28}],16:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11}],17:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./caml_int32.js":16,"./caml_obj.js":21,"./caml_utils.js":24}],18:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./curry.js":28,"_process":41}],19:[function(require,module,exports){
'use strict';
...
},{"./block.js":7,"./caml_builtin_exceptions.js":11}],22:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"_process":41}],24:[function(require,module,exports){
'use strict';
...
},{"./block.js":7,"./buffer.js":8,"./bytes.js":9,"./caml_builtin_exceptions.js":11,"./caml_bytes.js":12,"./caml_exceptions.js":13,"./caml_float.js":14,"./caml_format.js":15,"./caml_int32.js":16,"./caml_io.js":18,"./caml_obj.js":21,"./caml_string.js":22,"./camlinternalFormatBasics.js":26,"./char.js":27,"./curry.js":28,"./js_exn.js":32,"./pervasives.js":36,"./string.js":39,"./sys.js":40}],26:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./caml_string.js":22}],28:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":10}],29:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./caml_md5.js":19,"./caml_missing_polyfill.js":20,"./caml_string.js":22,"./char.js":27,"./pervasives.js":36,"./string.js":39}],30:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":15,"./caml_obj.js":21}],31:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":15,"./caml_int64.js":17}],32:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":13}],33:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./caml_obj.js":21,"./curry.js":28,"./pervasives.js":36}],34:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./curry.js":28}],35:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":15,"./caml_obj.js":21,"./sys.js":40}],36:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":11,"./caml_exceptions.js":13,"./caml_format.js":15,"./caml_io.js":18,"./caml_missing_polyfill.js":20,"./caml_obj.js":21,"./caml_string.js":22,"./caml_sys.js":23,"./camlinternalFormatBasics.js":26,"./curry.js":28}],37:[function(require,module,exports){
'use strict';
...
},{"./buffer.js":8,"./camlinternalFormat.js":25,"./curry.js":28,"./pervasives.js":36}],38:[function(require,module,exports){
'use strict';
...
},{"./array.js":6,"./caml_array.js":10,"./caml_builtin_exceptions.js":11,"./caml_int64.js":17,"./caml_string.js":22,"./caml_sys.js":23,"./curry.js":28,"./digest.js":29,"./int32.js":30,"./int64.js":31,"./nativeint.js":35,"./pervasives.js":36}],39:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":9,"./caml_int32.js":16,"./caml_string.js":22,"./list.js":33}],40:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":13,"./caml_sys.js":23}],41:[function(require,module,exports){
