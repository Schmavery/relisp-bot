...
function load_lib(filename, cb) {
  ...
  xhr.open("GET", "stdlib/" + (filename + ".lib"), true);
  xhr.send();
  return /* () */0;
}

var Environment = /* module */[/* load_lib */load_lib];
...
var Builtins = BuiltinFuncs.Builtins(Environment);
...
function process_input(state, cb, in_str) {
  ...
  if (e.tag) {
    ...
    return Curry._4(Evaluate.Eval[/* eval */9], e[0], Curry._1(Evaluate.Eval[/* create_initial_context */3], state), state, cb);
  }
}
...
function add_console_element(inner_text) {
  ...
  var inner_text$1 = inner_text.replace(new RegExp("\n", "g"), "<br>");
  var inner_text$2 = inner_text$1.replace(new RegExp(" ", "g"), "&nbsp;");
  new_node.innerHTML = inner_text$2;
  console_element.appendChild(new_node);
  return scroll_bottom(console_element);
}

var state = [Curry._1(Builtins[/* add_builtins */5], Evaluate.Eval[/* empty */0])];
...
input_element.onkeydown = function (e) {
  ...
  if (match >= 38) {
    ...
    process_input(state[0], function (param) {
          ...
          return add_console_element(Curry._1(Common.AST[/* to_string */3], param[0]));
        }, in_str);
    return false;
  }
};
...
},{"../../src/builtinFuncs.js":2,"../../src/common.js":3,"../../src/evaluate.js":5,"../../src/parse.js":6,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/random.js":39}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function Builtins(Environment) {
  var received_error = function (expected, args, name, state) {
    return /* tuple */[
            Curry._1(Common.AST[/* create_exception */2], "Received " + (Pervasives.string_of_int(List.length(args)) + (" arguments, expected " + (Pervasives.string_of_int(expected) + (" in call to '" + (name + "'")))))),
            state
          ];
  };
  var add_builtins = function (state) {
    var add_native_lambda = function (name, is_macro, func, state) {
      var asyncf = function (args, ctx, state, cb) {
        return Curry._1(cb, Curry._3(func, args, ctx, state));
      };
      var node = Curry._1(Common.AST[/* create_node */0], /* NativeFunc */Block.__(7, [/* record */[
                /* func */asyncf,
                /* is_macro */is_macro
              ]]));
      return Curry._3(Evaluate.Eval[/* define_native_symbol */4], state, name, node);
    };
    var add_native_lambda_async = function (name, is_macro, func, state) {
      var node = Curry._1(Common.AST[/* create_node */0], /* NativeFunc */Block.__(7, [/* record */[
                /* func */func,
                /* is_macro */is_macro
              ]]));
                      ...
                      var res = List.fold_left(function (acc, v) {
                            ...
                            if (acc.tag) {
                              ...
                              if (match.tag === 2) {
                                ...
                                if (match$1.tag === 2) {
                                  return /* Ok */Block.__(0, [/* Num */Block.__(2, [Curry._2(op, match[0], match$1[0])])]);
                                } else {
                                  exit = 1;
                                }
                              } else {
                            ...
                            if (exit === 1) {
                              return Curry._1(Common.AST[/* create_exception */2], "Called '" + (op_name + "' with something not a number."));
                            }
                            
                          }, /* Ok */Block.__(0, [hd]), args[1]);
                      $js = res.tag ? /* Error */Block.__(1, [res[0]]) : /* Ok */Block.__(0, [Curry._1(Common.AST[/* create_node */0], res[0])]);
                    } else {
                      $js = Curry._1(Common.AST[/* create_exception */2], "Called '" + (op_name + "' with something not a number."));
                    }
                  } else {
                    $js = Curry._1(Common.AST[/* create_exception */2], "Called '" + (op_name + "' with no args."));
                  }
                  return /* tuple */[
                          $js,
                          state
    ...
    var create_lambda_scope = function (node, map, arg_names, ctx, state) {
      ...
      switch (match.tag | 0) {
        case 0 : 
            var i = match[0];
            var match$1 = Curry._3(Evaluate.Eval[/* resolve_ident */6], i, ctx, state);
            if (match$1) {
              var x = match$1[0];
              var new_state = Curry._2(Evaluate.Eval[/* add_to_uuid_map */8], state, x);
              return /* Ok */Block.__(0, [/* tuple */[
                          Curry._3(Common.StringMap[/* add */3], i, x[/* uuid */0], map),
                          new_state
                        ]]);
            } else {
              return /* Ok */Block.__(0, [/* tuple */[
    ...
    var create_lambda_func = function (is_macro, args, ctx, state) {
      var uuid = Curry._1(Common.AST[/* gen_uuid */1], /* () */0);
        ...
        if (match.tag === 5) {
          ...
          if (match$1) {
            if (match$1[1]) {
              ...
              if (arg_names.tag) {
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */2], arg_names[0]),
                        state
                      ];
              } else {
                var match$2 = arg_names[0];
                var names = match$2[0];
                var match$3 = create_lambda_scope(body, Curry._2(Common.StringMap[/* singleton */4], "recur", uuid), names, ctx, state);
                if (match$3.tag) {
                  return /* tuple */[
                          Curry._1(Common.AST[/* create_exception */2], match$3[0]),
                          state
                        ];
                } else {
                  var match$4 = match$3[0];
                  var node_001 = /* value : Func */Block.__(6, [/* record */[
                        /* func */body,
                        /* args */names,
                        /* vararg */match$2[1],
                        /* scope */match$4[0],
                  ...
                  var new_state = Curry._2(Evaluate.Eval[/* add_to_uuid_map */8], match$4[1], node);
                  return /* tuple */[
                          /* Ok */Block.__(0, [node]),
                          new_state
                        ];
          ...
          if (match$5) {
            if (match$5[1]) {
              ...
              return /* tuple */[
                      Curry._1(Common.AST[/* create_exception */2], "Expected list as first argument in call to '" + (func_name + "'")),
                      state
                    ];
            }
          } else {
    ...
    var state$5 = add_native_lambda("lambda", /* true */1, function (param, param$1, param$2) {
          return create_lambda_func(/* false */0, param, param$1, param$2);
        }, state$4);
    var state$6 = add_native_lambda("macro", /* true */1, function (param, param$1, param$2) {
          return create_lambda_func(/* true */1, param, param$1, param$2);
        }, state$5);
    var state$7 = add_native_lambda("throw", /* false */0, function (args, _, state) {
          if (args) {
            if (args[1]) {
              return received_error(2, args, "throw", state);
            } else {
              return /* tuple */[
    ...
    var state$8 = add_native_lambda_async("try", /* true */1, function (args, ctx, state, $$return) {
          var exit = 0;
          if (args) {
            var match = args[1];
            if (match) {
                              ...
                              return Curry._4(Evaluate.Eval[/* eval */9], lambda, ctx, x[1], function (param) {
                                          ...
                                          if (exit === 1) {
                                            return Curry._1($$return, /* tuple */[
                                                        Curry._1(Common.AST[/* create_exception */2], "Expected lambda as second argument in call to 'try'"),
                                                        param[1]
                                                      ]);
                                          }
          ...
          if (exit === 1) {
            return Curry._1($$return, received_error(2, args, "try", state));
          }
          
        }, state$7);
    var state$9 = add_native_lambda_async("define", /* true */1, function (args, ctx, state, $$return) {
          var exit = 0;
          var ident;
          var other;
          if (args) {
            ...
            if (match.tag) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */2], "Expected ident as first argument in call to 'define'"),
                              state
                            ]);
                }
              } else {
          ...
          switch (exit) {
            case 1 : 
                return Curry._1($$return, received_error(2, args, "define", state));
            case 2 : 
                if (args) {
                  var match$4 = args[1];
                  if (match$4) {
                    var match$5 = match$4[0][/* value */1];
                    if (match$5.tag === 1) {
                ...
                if (ctx[/* depth */2] > 2) {
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */2], "Can only define at the top level"),
                              state
                            ]);
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */9], other, ctx, state, function (e) {
                              ...
                              if (match.tag) {
                                ...
                                if (res[/* value */1].tag === 7) {
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */2], "Cannot rename builtin function."),
                                              state
                                            ]);
                                } else {
                                  return Curry._1($$return, /* tuple */[
                                              /* Ok */Block.__(0, [Constants.empty_node]),
                                              Curry._3(Evaluate.Eval[/* define_user_symbol */5], e[1], ident, res)
                                            ]);
                                }
                              }
                            });
                  ...
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */2], "Cannot define reserved keyword [" + (ident + "].")),
                              state
                            ]);
                }
    ...
    var state$10 = add_native_lambda("quote", /* true */1, function (args, _, state) {
          if (args) {
            if (args[1]) {
              return received_error(1, args, "quote", state);
            } else {
              return /* tuple */[
    ...
    var state$11 = add_native_lambda_async("unquote", /* true */1, function (args, ctx, state, $$return) {
          if (args) {
            if (args[1]) {
              return Curry._1($$return, received_error(1, args, "unquote", state));
            } else {
      ...
      if (lst) {
        ...
        if (match.tag === 5) {
          ...
          if (match$1) {
            ...
            if (match$2.tag) {
              exit = 1;
            } else if (match$2[0] === "unquote-splice") {
              var match$3 = match$1[1];
              if (match$3) {
                if (match$3[1]) {
                  exit = 1;
                } else {
                  return Curry._4(Evaluate.Eval[/* eval */9], match$3[0], ctx, state, function (param) {
                              var state = param[1];
                              var res = param[0];
                              if (res.tag) {
                                return Curry._1($$return, /* tuple */[
                                ...
                                var match = res[0][/* value */1];
                                if (match.tag === 5) {
                                  return traverseH(tl, Pervasives.$at(acc, match[0]), ctx, state, $$return);
                                } else {
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */2], "'unquote-splice' only applies to lists"),
                                              state
                                            ]);
                                }
                              }
      ...
      if (match.tag === 5) {
        ...
        if (lst) {
          ...
          if (match$1.tag) {
            ...
            if (lst$1) {
              if (lst$1[1]) {
                return Curry._1($$return, received_error(1, lst$1, "unquote", state));
              } else {
        ...
        if (exit === 1) {
          return traverseH(lst, /* [] */0, ctx, state, function (param) {
                      ...
                      if (match.tag) {
                        ...
                        return Curry._1($$return, /* tuple */[
                                    /* Ok */Block.__(0, [Curry._1(Common.AST[/* create_node */0], /* List */Block.__(5, [match[0]]))]),
                                    param[1]
                                  ]);
                      }
                    });
    ...
    var state$12 = add_native_lambda_async("syntax-quote", /* true */1, function (args, ctx, state, $$return) {
          if (args) {
            if (args[1]) {
              return Curry._1($$return, received_error(1, args, "syntax-quote", state));
            } else {
    ...
    var state$13 = add_native_lambda_async("if", /* true */1, function (args, ctx, state, $$return) {
          var exit = 0;
          if (args) {
            var match = args[1];
            if (match) {
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */9], args[0], ctx, state, function (evaled_cond) {
                              ...
                              if (match.tag) {
                                ...
                                if (match$1.tag === 3) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */2], "First argument to 'if' must evaluate to boolean."),
                                              evaled_cond[1]
                                            ]);
                                }
                              }
          ...
          if (exit === 1) {
            return Curry._1($$return, received_error(3, args, "if", state));
          }
      ...
      if (lst) {
        ...
        return Curry._4(Evaluate.Eval[/* eval */9], lst[0], ctx, state, function (param) {
                    ...
                    if (match.tag) {
                      ...
                      var state = param[1];
                      return eval_list(tl, state, Curry._1(Evaluate.Eval[/* create_initial_context */3], state), $$return);
                    }
                  });
      } else {
    ...
    var state$14 = add_native_lambda_async("load", /* false */0, function (args, ctx, state, $$return) {
          var exit = 0;
          if (args) {
            var match = args[0][/* value */1];
            if (match.tag === 1) {
              if (args[1]) {
                ...
                return Curry._2(Environment[/* load_lib */0], lib_name, function (text) {
                            if (text) {
                              ...
                              return Curry._1($$return, /* tuple */[
                                          Curry._1(Common.AST[/* create_exception */2], "Could not load lib " + lib_name),
                                          state
                                        ]);
                            }
                          });
              ...
              return Curry._1($$return, /* tuple */[
                          Curry._1(Common.AST[/* create_exception */2], "Expected string as first argument in call to 'load'"),
                          state
                        ]);
            }
          } else {
          ...
          if (exit === 1) {
            return Curry._1($$return, received_error(1, args, "load", state));
          }
          
        }, state$13);
    var equal_helper = function (_param, _param$1) {
      while(true) {
        var param = _param$1;
        var param$1 = _param;
        var v2 = param[/* value */1];
        var v1 = param$1[/* value */1];
        if (param$1[/* uuid */0] === param[/* uuid */0]) {
          return /* true */1;
        } else if (Caml_obj.caml_equal(v1, v2)) {
          return /* true */1;
        } else {
          switch (v1.tag | 0) {
            case 0 : 
            ...
            case 6 : 
                if (v2.tag === 6) {
                  var match = v2[0];
                  var match$1 = v1[0];
                  if (Caml_obj.caml_equal(match$1[/* is_macro */4], match[/* is_macro */4])) {
                    if (Caml_obj.caml_equal(match$1[/* args */1], match[/* args */1])) {
                      if (Caml_obj.caml_equal(match$1[/* vararg */2], match[/* vararg */2])) {
                        if (Caml_obj.caml_equal(match$1[/* scope */3], match[/* scope */3])) {
                          _param$1 = match[/* func */0];
                          _param = match$1[/* func */0];
                          continue ;
          ...
          if (args) {
            ...
            if (match) {
              if (match[1]) {
                ...
                return /* tuple */[
                        /* Ok */Block.__(0, [Curry._1(Evaluate.Eval[/* to_bool_node */1], equal_helper(args[0], match[0]))]),
                        state
                      ];
              }
            } else {
          ...
          if (args) {
            ...
            if (match.tag === 5) {
              ...
              if (match$1) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */2], "Called 'car' on empty list"),
                        state
                      ];
              }
            } else if (args[1]) {
              ...
              return /* tuple */[
                      Curry._1(Common.AST[/* create_exception */2], "Expected list in call to 'car', got [" + (Curry._1(Common.AST[/* to_string */3], /* Ok */Block.__(0, [e])) + "] instead.")),
                      state
                    ];
            }
          } else {
            ...
            if (match.tag === 5) {
              ...
              if (match$1) {
                if (args[1]) {
                  ...
                  return /* tuple */[
                          /* Ok */Block.__(0, [Curry._1(Common.AST[/* create_node */0], /* List */Block.__(5, [match$1[1]]))]),
                          state
                        ];
                }
              } else if (args[1]) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */2], "Called 'cdr' on empty list"),
                        state
                      ];
              }
            } else if (args[1]) {
              ...
              return /* tuple */[
                      Curry._1(Common.AST[/* create_exception */2], "Expected list in call to 'cdr'"),
                      state
                    ];
            }
          } else {
            ...
            if (match) {
              ...
              if (match$1.tag === 5) {
                if (match[1]) {
                  ...
                  return /* tuple */[
                          /* Ok */Block.__(0, [Curry._1(Common.AST[/* create_node */0], /* List */Block.__(5, [/* :: */[
                                        args[0],
                                        match$1[0]
                                      ]]))]),
                          state
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */2], "Expected list as second arg in call to 'cons'"),
                        state
                      ];
              }
            } else {
          ...
          if (args) {
            ...
            if (match.tag === 6) {
              if (args[1]) {
                ...
                console.log(Curry._1(Common.StringMapHelper[/* to_string */2], match[0][/* scope */3]));
                return /* tuple */[
                        /* Ok */Block.__(0, [Constants.empty_node]),
                        state
                      ];
    ...
    var state$20 = add_native_lambda("DEBUG/print-state", /* false */0, function (args, _, state) {
          if (args) {
            ...
            console.log(Curry._1(Common.EvalState[/* to_string */1], state));
            return /* tuple */[
                    /* Ok */Block.__(0, [Constants.empty_node]),
                    state
                  ];
                ...
                if (args) {
                      ...
                      if (args[1]) {
                        ...
                        return Curry._4(Evaluate.Eval[/* eval */9], match$1[0], ctx, initial_state, function (param) {
                                    ...
                                    if (evaled_first.tag) {
                                      ...
                                      if (exit$1 === 2) {
                                        return Curry._1(cb, /* tuple */[
                                                    Curry._1(Common.AST[/* create_exception */2], Curry._1(Common.AST[/* to_string */3], evaled_first)),
                                                    initial_state
                                                  ]);
                                      }
                  ...
                  if (exit$1 === 2) {
                    if (args[1]) {
                      ...
                      return Curry._1(cb, /* tuple */[
                                  Curry._1(Common.AST[/* create_exception */2], "Expected list in call to 'DEBUG/expand-macro"),
                                  initial_state
                                ]);
                    }
                  }
...
},{"./common.js":3,"./constants.js":4,"./evaluate.js":5,"./parse.js":6,"bs-platform/lib/js/block.js":8,"bs-platform/lib/js/caml_builtin_exceptions.js":12,"bs-platform/lib/js/caml_obj.js":22,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/js_exn.js":33,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/pervasives.js":37,"bs-platform/lib/js/string.js":40}],3:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function usertable(state) {
  return state[/* userTable */0];
}

function symboltable(state) {
  return state[/* symbolTable */1];
}

function uuidmap(state) {
  return state[/* uuidToNodeMap */2];
}

function to_string$1(state) {
  return "====state====\nuserTable:\n" + (to_string(state[/* userTable */0]) + ("-------------\nsymbolTable:\n" + (to_string(state[/* symbolTable */1]) + "\n=============")));
}

function add_to_uuidmap(uuid, node, state) {
  return /* record */[
...
function add_to_symboltable(ident_name, uuid, state) {
  return /* record */[
          /* userTable */state[/* userTable */0],
          /* symbolTable */Curry._3(StringMap[/* add */3], ident_name, uuid, state[/* symbolTable */1]),
...
function create_exception(text) {
  return /* Error */Block.__(1, [/* tuple */[
              ...
              /* record */[
                /* uuid */gen_uuid(/* () */0),
                /* value : Str */Block.__(1, [text])
              ]
            ]]);
}

function to_string$2(ast) {
  if (ast.tag) {
    var param = ast[0];
    return "[Exception of " + (to_string$2(/* Ok */Block.__(0, [param[1]])) + ("]\nTrace: " + $$String.concat("\n       ", List.rev(param[0]))));
  } else {
    var match = ast[0][/* value */1];
    switch (match.tag | 0) {
      case 0 : 
          return match[0];
      case 1 : 
      ...
      case 3 : 
          return Pervasives.string_of_bool(match[0]);
      case 4 : 
          return "[Ref]";
      case 5 : 
          return "(" + ($$String.concat(" ", List.map(function (v) {
                            return to_string$2(/* Ok */Block.__(0, [v]));
                          }, match[0])) + ")");
      case 6 : 
          var f = match[0];
          var title = f[/* is_macro */4] ? "Macro" : "Function";
          var match$1 = f[/* vararg */2];
          var arg_list = match$1 ? Pervasives.$at(f[/* args */1], /* :: */[
                  "... " + match$1[0],
                  /* [] */0
                ]) : f[/* args */1];
          var args = $$String.concat(", ", arg_list);
          var body = to_string$2(/* Ok */Block.__(0, [f[/* func */0]]));
          return "[" + (title + (": " + (args + (" => " + (body + "]")))));
      case 7 : 
          if (match[0][/* is_macro */1] !== 0) {
            return "[Native Macro]";
          } else {
...
},{"bs-platform/lib/js/block.js":8,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/map.js":35,"bs-platform/lib/js/pervasives.js":37,"bs-platform/lib/js/printf.js":38,"bs-platform/lib/js/random.js":39,"bs-platform/lib/js/string.js":40}],4:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
var empty_node = Curry._1(Common.AST[/* create_node */0], /* List */Block.__(5, [/* [] */0]));

var true_node = Curry._1(Common.AST[/* create_node */0], /* Bool */Block.__(3, [/* true */1]));

var false_node = Curry._1(Common.AST[/* create_node */0], /* Bool */Block.__(3, [/* false */0]));

exports.empty_node = empty_node;
exports.true_node  = true_node;
exports.false_node = false_node;
/* empty_node Not a pure module */

},{"./common.js":3,"bs-platform/lib/js/block.js":8,"bs-platform/lib/js/curry.js":29}],5:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function to_bool_node(b) {
  if (b) {
    return Constants.true_node;
  } else {
    return Constants.false_node;
  }
}

function is_macro(func) {
  var match = func[/* value */1];
  switch (match.tag | 0) {
    case 6 : 
        return match[0][/* is_macro */4];
    case 7 : 
        return match[0][/* is_macro */1];
    default:
      return /* false */0;
  }
}
...
function create_initial_context(state) {
  return /* record */[
          /* argsUuidMap */Common.StringMap[/* empty */0],
          /* argsTable */Curry._1(Common.EvalState[/* usertable */2], state),
          /* depth */0
        ];
}

function add_to_uuid_map(state, node) {
  return Curry._3(Common.EvalState[/* add_to_uuidmap */5], node[/* uuid */0], node, state);
}

function is_reserved_symbol(state, ident_name) {
  return +(Curry._2(Common.StringMapHelper[/* get */0], ident_name, Curry._1(Common.EvalState[/* symboltable */3], state)) === /* None */0);
}

function define_native_symbol(state, ident_name, node) {
  return Curry._3(Common.EvalState[/* add_to_uuidmap */5], node[/* uuid */0], node, Curry._3(Common.EvalState[/* add_to_symboltable */6], ident_name, node[/* uuid */0], state));
}

function define_user_symbol(state, ident_name, node) {
  return Curry._3(Common.EvalState[/* add_to_uuidmap */5], node[/* uuid */0], node, Curry._3(Common.EvalState[/* add_to_usertable */7], ident_name, node[/* uuid */0], state));
}

function resolve_ident(ident_name, ctx, state) {
  var uuid = Curry._2(Common.StringMapHelper[/* get */0], ident_name, Curry._1(Common.EvalState[/* symboltable */3], state));
  var uuid$1 = uuid ? uuid : Curry._2(Common.StringMapHelper[/* get */0], ident_name, ctx[/* argsTable */1]);
  if (uuid$1) {
    var x = uuid$1[0];
    var match = Curry._2(Common.StringMapHelper[/* get */0], x, Curry._1(Common.EvalState[/* uuidmap */4], state));
    if (match) {
      return /* Some */[match[0]];
    } else {
      var match$1 = Curry._2(Common.StringMapHelper[/* get */0], x, ctx[/* argsUuidMap */0]);
      if (match$1) {
...
function create_lambda_arg_map(vararg, _func_args, _passed_args, _map) {
  while(true) {
    ...
    if (func_args) {
      if (passed_args) {
        _map = Curry._3(Common.StringMap[/* add */3], func_args[0], passed_args[0], map);
      ...
      if (exit === 1) {
        if (vararg) {
          return /* Ok */Block.__(0, [Curry._3(Common.StringMap[/* add */3], vararg[0], Curry._1(Common.AST[/* create_node */0], /* List */Block.__(5, [passed_args])), map)]);
        } else {
...
function $$eval(_original_node, ctx, state, _cb) {
  while(true) {
    ...
    var value = original_node[/* value */1];
    switch (value.tag | 0) {
      case 0 : 
          var ident = value[0];
          ...
          if (match) {
            ...
            return Curry._1(cb, /* tuple */[
                        Curry._1(Common.AST[/* create_exception */2], "Undeclared identifier [" + (ident + "].")),
                        state
                      ]);
          }
      case 5 : 
          ...
          if (lst) {
            ...
            return function (param) {
              ...
              if (evaled_first.tag) {
                ...
                var match$1 = func$2[/* value */1];
                switch (match$1.tag | 0) {
                  case 6 : 
                      if (match$1[0][/* is_macro */4] !== 0) {
                        func = func$2;
                        exit = 1;
                      } else {
                        func$1 = func$2;
                  ...
                  case 7 : 
                      ...
                      break;
                  default:
                    var node_str = Curry._1(Common.AST[/* to_string */3], /* Ok */Block.__(0, [func$2]));
                    return Curry._1(cb, /* tuple */[
                                Curry._1(Common.AST[/* create_exception */2], "Trying to call something that isn't a function. [" + (node_str + "]")),
                                state
                              ]);
                }
              }
...
function eval_lambda(called_func, args, func_name, ctx, state, cb) {
  var func_value = called_func[/* value */1];
  if (ctx[/* depth */2] > 512) {
    return Curry._1(cb, /* tuple */[
                Curry._1(Common.AST[/* create_exception */2], "Stack overflow > " + Pervasives.string_of_int(512)),
                state
              ]);
  } else {
    return eval_args(called_func, args, ctx, state, /* [] */0, function (maybe_args) {
                switch (func_value.tag | 0) {
                  case 6 : 
                      var match = maybe_args[0];
                      var match$1 = func_value[0];
                      if (match.tag) {
                        var match$2 = match[0];
                        return Curry._1(cb, /* tuple */[
                                    /* Error */Block.__(1, [/* tuple */[
                        ...
                        if (arg_to_node_map.tag) {
                          return Curry._1(cb, /* tuple */[
                                      Curry._1(Common.AST[/* create_exception */2], arg_to_node_map[0]),
                                      state
                                    ]);
                        } else {
                          var map = arg_to_node_map[0];
                          var argsUuidMap = Curry._3(Common.StringMap[/* fold */10], function (_, value, acc) {
                                return Curry._3(Common.StringMap[/* add */3], value[/* uuid */0], value, acc);
                              }, map, ctx[/* argsUuidMap */0]);
                          var arg_map = Curry._2(Common.StringMap[/* map */22], function (value) {
                                return value[/* uuid */0];
                              }, map);
                          var argsTable = Curry._2(Common.StringMapHelper[/* union */1], arg_map, match$1[/* scope */3]);
                          var ctx_002 = /* depth */ctx[/* depth */2] + 1 | 0;
                          var ctx$1 = /* record */[
                            /* argsUuidMap */argsUuidMap,
                            /* argsTable */argsTable,
                            ctx_002
                          ];
                  ...
                  case 7 : 
                      ...
                      if (match$3.tag) {
                        ...
                        return Curry._4(func_value[0][/* func */0], match$3[0], /* record */[
                                    /* argsUuidMap */ctx[/* argsUuidMap */0],
                                    /* argsTable */ctx[/* argsTable */1],
                                    /* depth */ctx[/* depth */2] + 1 | 0
                                  ], maybe_args[1], cb);
                      }
                      break;
                  default:
...
},{"./common.js":3,"./constants.js":4,"bs-platform/lib/js/block.js":8,"bs-platform/lib/js/caml_builtin_exceptions.js":12,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/pervasives.js":37}],6:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
    ...
    if (match) {
      ...
      if (c !== 34) {
        ...
        return /* ParseOk */Block.__(0, [/* tuple */[
                    pop(stream),
                    Curry._1(Common.AST[/* create_node */0], /* Str */Block.__(1, [acc]))
                  ]]);
      }
    } else {
      return /* ParseFail */Block.__(1, ["Unterminated string."]);
    ...
    if (exit === 1) {
      switch (acc) {
        ...
        default:
          return /* ParseOk */Block.__(0, [/* tuple */[
                      stream,
                      Curry._1(Common.AST[/* create_node */0], /* Ident */Block.__(0, [acc]))
                    ]]);
      }
    }
  ...
  while(true) {
    ...
    if (exit === 1) {
      ...
      if (num) {
        return /* ParseOk */Block.__(0, [/* tuple */[
                    stream,
                    Curry._1(Common.AST[/* create_node */0], /* Num */Block.__(2, [num[0]]))
                  ]]);
      } else {
...
function wrap_quote_sugar(ident_name, inner_val) {
  if (typeof inner_val === "number") {
    ...
    return /* ParseOk */Block.__(0, [/* tuple */[
                match[0],
                Curry._1(Common.AST[/* create_node */0], /* List */Block.__(5, [/* :: */[
                          Curry._1(Common.AST[/* create_node */0], /* Ident */Block.__(0, [ident_name])),
                          /* :: */[
                            match[1],
                            /* [] */0
                          ]
    ...
    if (match) {
      ...
      if (match$1 >= 33) {
        if (match$1 !== 41) {
          ...
          return /* ParseOk */Block.__(0, [/* tuple */[
                      pop(stream),
                      Curry._1(Common.AST[/* create_node */0], /* List */Block.__(5, [List.rev(acc)]))
                    ]]);
        }
      } else if (match$1 >= 11) {
        if (match$1 >= 32) {
  ...
  while(true) {
    ...
    if (match) {
      ...
      if (typeof match$1 === "number") {
        return Curry._1(Common.AST[/* create_exception */2], "Unexpected end of input.");
      } else if (match$1.tag) {
        return Curry._1(Common.AST[/* create_exception */2], match$1[0]);
      } else {
...
function parse_single(s) {
  ...
  if (typeof match === "number") {
    ...
    return Curry._1(Common.AST[/* create_exception */2], match[0]);
  } else {
    var match$1 = match[0];
    var match$2 = peek(trim_comments(match$1[0]));
    if (match$2) {
      return Curry._1(Common.AST[/* create_exception */2], "Unexpected character [" + (append_char("", match$2[0]) + "]."));
    } else {
...
},{"./common.js":3,"./constants.js":4,"bs-platform/lib/js/block.js":8,"bs-platform/lib/js/caml_builtin_exceptions.js":12,"bs-platform/lib/js/caml_format.js":16,"bs-platform/lib/js/caml_string.js":23,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/string.js":40}],7:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":11,"./caml_builtin_exceptions.js":12,"./caml_exceptions.js":14,"./curry.js":29,"./js_exn.js":33}],8:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":10,"./caml_builtin_exceptions.js":12,"./caml_string.js":23,"./curry.js":29,"./pervasives.js":37,"./string.js":40,"./sys.js":41}],10:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./caml_int32.js":17,"./caml_obj.js":22,"./caml_string.js":23,"./char.js":28,"./curry.js":29,"./list.js":34,"./pervasives.js":37}],11:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12}],12:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12}],14:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./caml_int32.js":17,"./caml_int64.js":18,"./caml_utils.js":25,"./curry.js":29}],17:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12}],18:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./caml_int32.js":17,"./caml_obj.js":22,"./caml_utils.js":25}],19:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./curry.js":29,"_process":42}],20:[function(require,module,exports){
'use strict';
...
},{"./block.js":8,"./caml_builtin_exceptions.js":12}],23:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12}],24:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"_process":42}],25:[function(require,module,exports){
'use strict';
...
},{"./block.js":8,"./buffer.js":9,"./bytes.js":10,"./caml_builtin_exceptions.js":12,"./caml_bytes.js":13,"./caml_exceptions.js":14,"./caml_float.js":15,"./caml_format.js":16,"./caml_int32.js":17,"./caml_io.js":19,"./caml_obj.js":22,"./caml_string.js":23,"./camlinternalFormatBasics.js":27,"./char.js":28,"./curry.js":29,"./js_exn.js":33,"./pervasives.js":37,"./string.js":40,"./sys.js":41}],27:[function(require,module,exports){
'use strict';
...
},{"./block.js":8}],28:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./caml_string.js":23}],29:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":11}],30:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./caml_md5.js":20,"./caml_missing_polyfill.js":21,"./caml_string.js":23,"./char.js":28,"./pervasives.js":37,"./string.js":40}],31:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":16,"./caml_obj.js":22}],32:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":16,"./caml_int64.js":18}],33:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":14}],34:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./caml_obj.js":22,"./curry.js":29,"./pervasives.js":37}],35:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./curry.js":29}],36:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":16,"./caml_obj.js":22,"./sys.js":41}],37:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":12,"./caml_exceptions.js":14,"./caml_format.js":16,"./caml_io.js":19,"./caml_missing_polyfill.js":21,"./caml_obj.js":22,"./caml_string.js":23,"./caml_sys.js":24,"./camlinternalFormatBasics.js":27,"./curry.js":29}],38:[function(require,module,exports){
'use strict';
...
},{"./buffer.js":9,"./camlinternalFormat.js":26,"./curry.js":29,"./pervasives.js":37}],39:[function(require,module,exports){
'use strict';
...
},{"./array.js":7,"./caml_array.js":11,"./caml_builtin_exceptions.js":12,"./caml_int64.js":18,"./caml_string.js":23,"./caml_sys.js":24,"./curry.js":29,"./digest.js":30,"./int32.js":31,"./int64.js":32,"./nativeint.js":36,"./pervasives.js":37}],40:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":10,"./caml_int32.js":17,"./caml_string.js":23,"./list.js":34}],41:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":14,"./caml_sys.js":24}],42:[function(require,module,exports){
