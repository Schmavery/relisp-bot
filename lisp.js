...
var Web_Tar__Parse    = require("./web_Tar__Parse");
var Curry             = require("bs-platform/lib/js/curry");
var Web_Tar__Common   = require("./web_Tar__Common");
var Web_Tar__Builtins = require("./web_Tar__Builtins");
...
function scroll_bottom(obj) {
  return obj.scrollTop = obj.scrollHeight;
}

Random.self_init(/* () */0);

function process_input(in_str, state) {
  var e = Web_Tar__Parse.parse(in_str);
  if (e.tag) {
    return /* tuple */[
            Web_Tar__Common.string_of_ast(e),
            state
          ];
  }
  else {
...
function add_console_element(inner_text) {
  ...
  return console_element.scrollTop = console_element.scrollHeight;
}

var state = [Web_Tar__Builtins.add_builtins(Web_Tar__Evaluate.Eval[/* empty */0])];
...
input_element.onkeydown = function (e) {
  ...
  if (match >= 38) {
    ...
    position[0] = 0;
    var match$3 = process_input(in_str, state[0]);
    state[0] = match$3[1];
    input_element.value = "";
    add_console_element("> " + in_str);
    add_console_element(match$3[0]);
    return false;
  }
};
...
},{"./web_Tar__Builtins":2,"./web_Tar__Common":3,"./web_Tar__Evaluate":4,"./web_Tar__Parse":5,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/list":32,"bs-platform/lib/js/random":37}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.3.2 , PLEASE EDIT WITH CARE
'use strict';
...
function add_builtins(state) {
  var add_native_lambda = function (name, is_macro, func, state) {
    var node = Web_Tar__Common.create_node(/* NativeFunc */Block.__(7, [/* record */[
              /* func */func,
              /* is_macro */is_macro
            ]]));
    ...
    return add_native_lambda(op_name, /* false */0, function (args, _, state) {
                ...
                if (args) {
                  ...
                  if (hd.tag === 2) {
                          ...
                          if (acc.tag) {
                            ...
                            if (match.tag === 2) {
                              ...
                              if (match$1.tag === 2) {
                                ...
                                return Web_Tar__Common.create_exception("Called '" + (op_name + "' with something not a number."));
                              }
                            }
                            else {
                              return Web_Tar__Common.create_exception("Called '" + (op_name + "' with something not a number."));
                    ...
                    $js = res.tag ? /* Error */Block.__(1, [res[0]]) : /* Ok */Block.__(0, [Web_Tar__Common.create_node(res[0])]);
                  }
                  else {
                    $js = Web_Tar__Common.create_exception("Called '" + (op_name + "' with something not a number."));
                  }
                }
                else {
                  $js = Web_Tar__Common.create_exception("Called '" + (op_name + "' with no args."));
                }
                return /* tuple */[
                        $js,
                        state
  ...
  var create_lambda_func = function (is_macro, args, ctx, state) {
    var uuid = Web_Tar__Common.gen_uuid(/* () */0);
    var exit = 0;
    if (args) {
      var match = args[0][/* value */1];
      if (match.tag === 5) {
        ...
        if (match$1) {
          if (match$1[1]) {
            ...
            if (arg_names.tag) {
              return /* tuple */[
                      Web_Tar__Common.create_exception(arg_names[0]),
                      state
                    ];
            }
            else {
              ...
              var names = match$2[0];
              var match$3 = create_lambda_scope(body, Curry._2(Web_Tar__Common.StringMap[/* singleton */4], "recur", uuid), names, ctx, state);
              if (match$3.tag) {
                return /* tuple */[
                        Web_Tar__Common.create_exception(match$3[0]),
                        state
                      ];
              }
              else {
        ...
        if (match$5) {
          if (match$5[1]) {
            ...
            return /* tuple */[
                    Web_Tar__Common.create_exception("Expected list as first argument in call to 'lambda'"),
                    state
                  ];
          }
        }
    ...
    if (exit === 1) {
      ...
      return /* tuple */[
              Web_Tar__Common.create_exception("Received " + (received + " arguments, expected 2 in call to 'lambda'")),
              state
            ];
    }
  ...
  var state$7 = add_native_lambda("throw", /* false */0, function (args, _, state) {
        ...
        if (exit === 1) {
          var received = Pervasives.string_of_int(List.length(args));
          $js = Web_Tar__Common.create_exception("Received " + (received + " arguments, expected 2 in call to 'throw'"));
        }
        return /* tuple */[
                $js,
                state
  ...
  var state$8 = add_native_lambda("try", /* true */1, function (args, ctx, state) {
        var exit = 0;
        if (args) {
          var match = args[1];
          if (match) {
            if (match[1]) {
              ...
              if (match$1.tag) {
                ...
                if (match$3.tag) {
                  return /* tuple */[
                          Web_Tar__Common.create_exception("Expected lambda as second argument in call to 'catch'"),
                          match$2[1]
                        ];
                }
                else {
        ...
        if (exit === 1) {
          var received = Pervasives.string_of_int(List.length(args));
          return /* tuple */[
                  Web_Tar__Common.create_exception("Received " + (received + " arguments, expected 2 in call to 'catch'")),
                  state
                ];
        }
        
      }, state$7);
  var state$9 = add_native_lambda("define", /* true */1, function (args, ctx, state) {
        var exit = 0;
        if (args) {
          var match = args[0][/* value */1];
          if (match.tag) {
            ...
            if (match$1) {
              if (match$1[1]) {
                ...
                return /* tuple */[
                        Web_Tar__Common.create_exception("Expected ident as first argument in call to 'define'"),
                        state
                      ];
              }
            }
            ...
            if (match$2) {
              if (match$2[1]) {
                ...
                if (ctx[/* depth */2] > 2) {
                  return /* tuple */[
                          Web_Tar__Common.create_exception("Can only define at the top level"),
                          state
                        ];
                }
                  ...
                  if (match$3.tag) {
                    ...
                    if (res[/* value */1].tag === 7) {
                      return /* tuple */[
                              Web_Tar__Common.create_exception("Cannot rename builtin function [" + (ident + "].")),
                              state
                            ];
                    }
                    else {
                  ...
                  return /* tuple */[
                          Web_Tar__Common.create_exception("Cannot define reserved keyword [" + (ident + "].")),
                          state
                        ];
                }
              }
          ...
          return /* tuple */[
                  Web_Tar__Common.create_exception("Received no arguments, expected 2 in call to 'define'"),
                  state
                ];
        }
        if (exit === 1) {
  ...
  var state$10 = add_native_lambda("quote", /* true */1, function (args, _, state) {
        ...
        if (exit === 1) {
          var received = Pervasives.string_of_int(List.length(args));
          return /* tuple */[
                  Web_Tar__Common.create_exception("Received " + (received + " arguments, expected 1 in call to 'quote'")),
                  state
                ];
        }
...
},{"./web_Tar__Common":3,"./web_Tar__Evaluate":4,"bs-platform/lib/js/block":7,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/list":32,"bs-platform/lib/js/pervasives":35}],3:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.3.2 , PLEASE EDIT WITH CARE
'use strict';
  ...
  if (ast.tag) {
    ...
    switch (match.tag | 0) {
      ...
      case 6 : 
          var f = match[0];
          var f$1 = f;
          var title = f$1[/* is_macro */4] ? "Macro" : "Function";
          var match$1 = f$1[/* vararg */2];
          var arg_list = match$1 ? Pervasives.$at(f$1[/* args */1], /* :: */[
                  "... " + match$1[0],
                  /* [] */0
                ]) : f$1[/* args */1];
          var args = $$String.concat(", ", arg_list);
          var body = string_of_ast(/* Ok */Block.__(0, [f$1[/* func */0]]));
...
},{"bs-platform/lib/js/block":7,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/list":32,"bs-platform/lib/js/map":33,"bs-platform/lib/js/pervasives":35,"bs-platform/lib/js/printf":36,"bs-platform/lib/js/random":37,"bs-platform/lib/js/string":38}],4:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.3.2 , PLEASE EDIT WITH CARE
'use strict';
...
var empty_000 = /* userTable */Web_Tar__Common.StringMap[/* empty */0];

var empty_001 = /* symbolTable */Web_Tar__Common.StringMap[/* empty */0];

var empty_002 = /* uuidToNodeMap */Web_Tar__Common.StringMap[/* empty */0];
...
function create_initial_context(state) {
  return /* record */[
          /* argsUuidMap */Web_Tar__Common.StringMap[/* empty */0],
...
function add_to_uuid_map(state, node) {
  return /* record */[
          ...
          /* uuidToNodeMap */Curry._3(Web_Tar__Common.StringMap[/* add */3], node[/* uuid */0], node, state[/* uuidToNodeMap */2])
        ];
}

function is_reserved_symbol(state, ident_name) {
  return +(Web_Tar__Common.stringmap_get(ident_name, state[/* symbolTable */1]) === /* None */0);
}

function define_native_symbol(state, ident_name, node) {
  return /* record */[
          /* userTable */state[/* userTable */0],
          /* symbolTable */Curry._3(Web_Tar__Common.StringMap[/* add */3], ident_name, node[/* uuid */0], state[/* symbolTable */1]),
          /* uuidToNodeMap */Curry._3(Web_Tar__Common.StringMap[/* add */3], node[/* uuid */0], node, state[/* uuidToNodeMap */2])
        ];
}
...
function define_user_symbol(state, ident_name, node) {
  return /* record */[
          /* userTable */Curry._3(Web_Tar__Common.StringMap[/* add */3], ident_name, node[/* uuid */0], state[/* userTable */0]),
          /* symbolTable */state[/* symbolTable */1],
          /* uuidToNodeMap */Curry._3(Web_Tar__Common.StringMap[/* add */3], node[/* uuid */0], node, state[/* uuidToNodeMap */2])
        ];
}
...
function resolve_ident(ident_name, ctx, state) {
  var uuid = Web_Tar__Common.stringmap_get(ident_name, state[/* symbolTable */1]);
  var uuid$1 = uuid ? uuid : Web_Tar__Common.stringmap_get(ident_name, ctx[/* argsTable */1]);
  if (uuid$1) {
    var x = uuid$1[0];
    var match = Web_Tar__Common.stringmap_get(x, state[/* uuidToNodeMap */2]);
    if (match) {
      return /* Some */[match[0]];
    }
    else {
      var match$1 = Web_Tar__Common.stringmap_get(x, ctx[/* argsUuidMap */0]);
      if (match$1) {
...
function create_lambda_arg_map(vararg, _func_args, _passed_args, _map) {
  while(true) {
    ...
    if (func_args) {
      if (passed_args) {
        _map = Curry._3(Web_Tar__Common.StringMap[/* add */3], func_args[0], passed_args[0], map);
        ...
        var received = Curry._1(Web_Tar__Common.StringMap[/* cardinal */15], map);
      ...
      if (exit === 1) {
        if (vararg) {
          return /* Ok */Block.__(0, [Curry._3(Web_Tar__Common.StringMap[/* add */3], vararg[0], /* record */[
                          /* uuid */Web_Tar__Common.gen_uuid(/* () */0),
                          /* value : List */Block.__(5, [passed_args])
                        ], map)]);
        }
        else {
          var expected$1 = Curry._1(Web_Tar__Common.StringMap[/* cardinal */15], map);
...
function $$eval(_original_node, ctx, _state) {
  while(true) {
    var state = _state;
    ...
    switch (value.tag | 0) {
      case 0 : 
          ...
          if (match) {
            ...
            return /* tuple */[
                    Web_Tar__Common.create_exception("Undeclared identifier [" + (ident + "].")),
                    state
                  ];
          }
      case 5 : 
          ...
          if (lst) {
            ...
            var match$2 = $$eval(first, ctx, state);
            var state$1 = match$2[1];
            var evaled_first = match$2[0];
            if (evaled_first.tag) {
              return /* tuple */[
              ...
              var func = evaled_first[0];
              var match$3 = func[/* value */1];
              switch (match$3.tag | 0) {
                case 6 : 
                    return eval_lambda(func, args, name, ctx, state$1);
                case 7 : 
                    if (match$3[0][/* is_macro */1]) {
                      return eval_lambda(func, args, name, ctx, state$1);
                    }
                    else {
                      var e = eval_lambda(func, args, name, ctx, state$1);
                      var match$4 = e[0];
                      if (match$4.tag) {
                        return e;
                      }
                ...
                default:
                  return /* tuple */[
                          Web_Tar__Common.create_exception("Trying to call something that isn't a function. [" + (Web_Tar__Common.string_of_ast(/* Ok */Block.__(0, [func])) + "]")),
                          state$1
                        ];
              }
            }
...
function eval_lambda(called_func, args, _, ctx, state) {
  var func_value = called_func[/* value */1];
  if (ctx[/* depth */2] > 512) {
    return /* tuple */[
            Web_Tar__Common.create_exception("Stack overflow > " + Pervasives.string_of_int(512)),
            state
          ];
  }
  else {
    var maybe_args = eval_args(called_func, args, ctx, state);
    switch (func_value.tag | 0) {
      case 6 : 
          var match = func_value[0];
          var match$1 = maybe_args[0];
          if (match$1.tag) {
            return maybe_args;
          }
          else {
            var state$1 = maybe_args[1];
            var arg_to_node_map = create_lambda_arg_map(match[/* vararg */2], match[/* args */1], match$1[0], Web_Tar__Common.StringMap[/* empty */0]);
            if (arg_to_node_map.tag) {
              return /* tuple */[
                      Web_Tar__Common.create_exception(arg_to_node_map[0]),
                      state$1
                    ];
            }
            else {
              var map = arg_to_node_map[0];
              var argsUuidMap = Curry._3(Web_Tar__Common.StringMap[/* fold */10], function (_, value, acc) {
                    return Curry._3(Web_Tar__Common.StringMap[/* add */3], value[/* uuid */0], value, acc);
                  }, map, ctx[/* argsUuidMap */0]);
              var arg_map = Curry._2(Web_Tar__Common.StringMap[/* map */22], function (value) {
                    return value[/* uuid */0];
                  }, map);
              var argsTable = Web_Tar__Common.stringmap_union(arg_map, match[/* scope */3]);
              ...
              return $$eval(match[/* func */0], ctx$1, state$1);
            }
          }
          break;
      case 7 : 
          ...
          if (match$2.tag) {
            ...
            return Curry._3(func_value[0][/* func */0], match$2[0], /* record */[
...
function eval_args(func, args, ctx, state) {
  if (is_macro(func)) {
    return /* tuple */[
            /* Ok */Block.__(0, [args]),
            state
...
function parse(s) {
  ...
  var parse$1 = function (_stream) {
    while(true) {
      ...
      if (match) {
          ...
          if (switcher > 8 || switcher < 0) {
            ...
            switch (switcher) {
              case 0 : 
                  ...
                  continue ;
                  case 2 : 
                  var _stream$1 = pop(stream);
                  var _acc = "";
                  while(true) {
                    var acc = _acc;
                    var stream$1 = _stream$1;
                    var match$1 = peek(stream$1);
                    if (match$1) {
                      var c$1 = match$1[0];
                      if (c$1 !== 34) {
                        if (c$1 !== 92) {
                          _acc = acc + $$String.make(1, c$1);
                          _stream$1 = pop(stream$1);
                          continue ;
                          
                        }
                        else {
                          var pop_str = pop(stream$1);
                          var match$2 = peek(pop_str);
                          if (match$2) {
                            var c$2 = match$2[0];
                            var exit$1 = 0;
                            if (c$2 >= 92) {
                              if (c$2 !== 110) {
                                if (c$2 !== 116) {
                                  if (c$2 >= 93) {
                                    ...
                                    _acc = acc + $$String.make(1, /* "\\" */92);
                                    _stream$1 = pop(pop_str);
                                    continue ;
                                    
                                  }
                                }
                                else {
                                  _acc = acc + $$String.make(1, /* "\t" */9);
                                  _stream$1 = pop(pop_str);
                                  continue ;
                              ...
                              _acc = acc + $$String.make(1, /* "\"" */34);
                              _stream$1 = pop(pop_str);
                              continue ;
                              
                            }
                            if (exit$1 === 1) {
                              return /* ParseFail */Block.__(1, ["Invalid escape sequence \\" + ($$String.make(1, c$2) + ".")]);
                            }
                        ...
                        return /* ParseOk */Block.__(0, [/* tuple */[
                                    pop(stream$1),
                                    Web_Tar__Common.create_node(/* Str */Block.__(1, [acc]))
                                  ]]);
                      }
                    }
                    else {
              ...
              case 7 : 
                  ...
                  break;
              case 8 : 
                  var _stream$2 = pop(stream);
                  var _acc$1 = /* [] */0;
                  while(true) {
                    var acc$1 = _acc$1;
                    var stream$2 = _stream$2;
                    var match$3 = peek(stream$2);
                    if (match$3) {
                      var exit$2 = 0;
                      var switcher$1 = match$3[0] - 9 | 0;
                      if (switcher$1 > 23 || switcher$1 < 0) {
                        if (switcher$1 !== 32) {
                          exit$2 = 1;
                        }
                        else {
                          return /* ParseOk */Block.__(0, [/* tuple */[
                                      pop(stream$2),
                                      Web_Tar__Common.create_node(/* List */Block.__(5, [List.rev(acc$1)]))
                                    ]]);
                        }
                      }
                      else if (switcher$1 > 22 || switcher$1 < 2) {
                        _stream$2 = pop(stream$2);
                        continue ;
        ...
        if (exit === 1) {
          if (is_num(c)) {
            var _stream$3 = stream;
            var _acc$2 = "";
            while(true) {
              var acc$2 = _acc$2;
              var stream$3 = _stream$3;
              var match$5 = peek(stream$3);
              var exit$3 = 0;
              if (match$5) {
                var c$3 = match$5[0];
                if (is_num(c$3)) {
                  _acc$2 = acc$2 + $$String.make(1, c$3);
                  _stream$3 = pop(stream$3);
                  continue ;
              ...
              if (exit$3 === 1) {
                var num;
                try {
                  num = /* Some */[Caml_format.caml_float_of_string(acc$2)];
                }
                catch (exn){
                  num = /* None */0;
                }
                if (num) {
                  return /* ParseOk */Block.__(0, [/* tuple */[
                              stream$3,
                              Web_Tar__Common.create_node(/* Num */Block.__(2, [num[0]]))
                            ]]);
                }
                else {
                  return /* ParseFail */Block.__(1, ["Could not parse number [" + (acc$2 + "].")]);
                }
              }
            ...
            var _stream$4 = stream;
            var _acc$3 = "";
            while(true) {
              var acc$3 = _acc$3;
              var stream$4 = _stream$4;
              var match$6 = peek(stream$4);
              var exit$4 = 0;
              if (match$6) {
                var c$4 = match$6[0];
                var exit$5 = 0;
                if (c$4 >= 11) {
                  var switcher$2 = c$4 - 32 | 0;
                  if (switcher$2 > 9 || switcher$2 < 0) {
                    exit$5 = 2;
                  }
                  else {
                    switch (switcher$2) {
                ...
                if (exit$5 === 2) {
                  _acc$3 = acc$3 + $$String.make(1, c$4);
                  _stream$4 = pop(stream$4);
                  continue ;
  ...
  var stream = create(s);
  var match = parse$1(stream);
  if (typeof match === "number") {
    return Web_Tar__Common.create_exception("Unexpected end of input.");
  }
  else if (match.tag) {
    return Web_Tar__Common.create_exception(match[0]);
  }
  else {
    return /* Ok */Block.__(0, [match[0][1]]);
  }
}
...
},{"bs-platform/lib/js/caml_array":10,"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_exceptions":13,"bs-platform/lib/js/curry":28}],7:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/bytes":9,"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_string":22,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/pervasives":35,"bs-platform/lib/js/string":38,"bs-platform/lib/js/sys":39}],9:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_int32":16,"bs-platform/lib/js/caml_obj":20,"bs-platform/lib/js/caml_string":22,"bs-platform/lib/js/char":27,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/list":32,"bs-platform/lib/js/pervasives":35}],10:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11}],13:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_int32":16,"bs-platform/lib/js/caml_int64":17,"bs-platform/lib/js/caml_string":22,"bs-platform/lib/js/caml_utils":24,"bs-platform/lib/js/curry":28}],16:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11}],17:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_int32":16,"bs-platform/lib/js/caml_obj":20,"bs-platform/lib/js/caml_utils":24}],18:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":40,"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/curry":28}],19:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/block":7,"bs-platform/lib/js/caml_builtin_exceptions":11}],21:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_array":10,"bs-platform/lib/js/caml_builtin_exceptions":11}],22:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11}],23:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":40,"bs-platform/lib/js/caml_builtin_exceptions":11}],24:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/block":7,"bs-platform/lib/js/buffer":8,"bs-platform/lib/js/bytes":9,"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_bytes":12,"bs-platform/lib/js/caml_exceptions":13,"bs-platform/lib/js/caml_float":14,"bs-platform/lib/js/caml_format":15,"bs-platform/lib/js/caml_int32":16,"bs-platform/lib/js/caml_io":18,"bs-platform/lib/js/caml_obj":20,"bs-platform/lib/js/caml_string":22,"bs-platform/lib/js/camlinternalFormatBasics":26,"bs-platform/lib/js/char":27,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/pervasives":35,"bs-platform/lib/js/string":38,"bs-platform/lib/js/sys":39}],26:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/block":7}],27:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_string":22}],28:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_array":10,"bs-platform/lib/js/caml_oo":21}],29:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_md5":19,"bs-platform/lib/js/caml_string":22,"bs-platform/lib/js/char":27,"bs-platform/lib/js/pervasives":35,"bs-platform/lib/js/string":38}],30:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_format":15,"bs-platform/lib/js/caml_obj":20}],31:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_format":15,"bs-platform/lib/js/caml_int64":17}],32:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_obj":20,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/pervasives":35}],33:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/curry":28}],34:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_format":15,"bs-platform/lib/js/caml_obj":20,"bs-platform/lib/js/sys":39}],35:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_exceptions":13,"bs-platform/lib/js/caml_format":15,"bs-platform/lib/js/caml_io":18,"bs-platform/lib/js/caml_obj":20,"bs-platform/lib/js/caml_string":22,"bs-platform/lib/js/camlinternalFormatBasics":26,"bs-platform/lib/js/curry":28}],36:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/buffer":8,"bs-platform/lib/js/camlinternalFormat":25,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/pervasives":35}],37:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/array":6,"bs-platform/lib/js/caml_array":10,"bs-platform/lib/js/caml_builtin_exceptions":11,"bs-platform/lib/js/caml_int64":17,"bs-platform/lib/js/caml_string":22,"bs-platform/lib/js/caml_sys":23,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/digest":29,"bs-platform/lib/js/int32":30,"bs-platform/lib/js/int64":31,"bs-platform/lib/js/nativeint":34,"bs-platform/lib/js/pervasives":35}],38:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/bytes":9,"bs-platform/lib/js/caml_int32":16,"bs-platform/lib/js/caml_string":22,"bs-platform/lib/js/list":32}],39:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_exceptions":13}],40:[function(require,module,exports){
