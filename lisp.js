...
},{"../../src/builtinFuncs.js":2,"../../src/common.js":4,"../../src/evaluate.js":5,"../../src/parse.js":6,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/random.js":39}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
                  ...
                  if (args) {
                    ...
                    if (hd.tag === 2) {
                      var res = List.fold_left(function (acc, v) {
                            ...
                            if (exit === 1) {
                              return Curry._1(Common.AST[/* create_exception */1], "Called '" + (op_name + "' with something not a number."));
                            }
                            
                          }, /* Ok */Block.__(0, [hd]), args[1]);
                      $js = res.tag ? /* Error */Block.__(1, [res[0]]) : /* Ok */Block.__(0, [res[0]]);
                    } else {
                      $js = Curry._1(Common.AST[/* create_exception */1], "Called '" + (op_name + "' with something not a number."));
                    }
                  } else {
                    $js = Curry._1(Common.AST[/* create_exception */1], "Called '" + (op_name + "' with no args."));
                  }
                  return /* tuple */[
                          $js,
                          state
        ...
        case 0 : 
            ...
            if (match) {
              ...
              if (node$1.tag === 7) {
                ...
                var hash = Curry._1(Common.AST[/* hash */0], node$1);
        ...
        if (match.tag === 5) {
          ...
          if (match$1) {
            if (match$1[1]) {
              ...
              if (arg_names.tag) {
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */1], arg_names[0]),
                        state
                      ];
              } else {
                ...
                if (match$3.tag) {
                  return /* tuple */[
                          Curry._1(Common.AST[/* create_exception */1], match$3[0]),
                          state
                        ];
                } else {
                  var match$4 = match$3[0];
                  var idents = match$4[0];
                  var node_dummy = /* Func */Block.__(6, [/* record */[
                        /* func */body,
                        /* args */names,
                        /* vararg */vararg,
                        /* scope */idents,
                  ...
                  var hash = Curry._1(Common.AST[/* hash */0], node_dummy);
                  var node = /* Func */Block.__(6, [/* record */[
                        /* func */body,
                        /* args */names,
                        /* vararg */vararg,
                        /* scope */idents,
          ...
          if (match$5) {
            if (match$5[1]) {
              ...
              return /* tuple */[
                      Curry._1(Common.AST[/* create_exception */1], "Expected list as first argument in call to '" + (func_name + "'")),
                      state
                    ];
            }
          } else {
                              ...
                              return Curry._4(Evaluate.Eval[/* eval */9], lambda, ctx, x[1], function (param) {
                                          ...
                                          if (exit === 1) {
                                            return Curry._1($$return, /* tuple */[
                                                        Curry._1(Common.AST[/* create_exception */1], "Expected lambda as second argument in call to 'try'"),
                                                        param[1]
                                                      ]);
                                          }
    ...
    var state$9 = BuiltinHelper.add_native_lambda_async("define", /* Some */["Takes an identifier and a value to be set to that identifier. Optionally, a string can be passed in after the identifier to be used as docs."], /* true */1, function (args, ctx, state, $$return) {
            ...
            if (match.tag) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */1], "Expected ident as first argument in call to 'define'"),
                              state
                            ]);
                }
              } else {
          ...
          switch (exit) {
            ...
            case 2 : 
                ...
                if (ctx[/* depth */1] > 2) {
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */1], "Can only define at the top level"),
                              state
                            ]);
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */9], other, ctx, state, function (e) {
                              ...
                              if (match.tag) {
                                ...
                                if (res.tag === 7) {
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */1], "Cannot rename builtin function."),
                                              state
                                            ]);
                                } else {
                                  return Curry._1($$return, /* tuple */[
                  ...
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */1], "Cannot define reserved keyword [" + (ident + "].")),
                              state
                            ]);
                }
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */9], match$2[0], ctx, state, function (param) {
                              ...
                              if (res.tag) {
                                ...
                                if (match.tag === 5) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */1], "'unquote-splice' only applies to lists"),
                                              state
                                            ]);
                                }
                              }
                  ...
                  return Curry._4(Evaluate.Eval[/* eval */9], args[0], ctx, state, function (evaled_cond) {
                              ...
                              if (match.tag) {
                                ...
                                if (match$1.tag === 3) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */1], "First argument to 'if' must evaluate to boolean."),
                                              evaled_cond[1]
                                            ]);
                                }
                              }
    ...
    var state$14 = BuiltinHelper.add_native_lambda_async("load", /* None */0, /* false */0, function (args, ctx, state, $$return) {
          ...
          if (args) {
            ...
            if (match.tag === 1) {
              if (args[1]) {
                ...
                return Curry._2(Environment[/* load_lib */0], lib_name, function (text) {
                            if (text) {
                              ...
                              return Curry._1($$return, /* tuple */[
                                          Curry._1(Common.AST[/* create_exception */1], "Could not load lib " + lib_name),
                                          state
                                        ]);
                            }
                          });
              ...
              return Curry._1($$return, /* tuple */[
                          Curry._1(Common.AST[/* create_exception */1], "Expected string as first argument in call to 'load'"),
                          state
                        ]);
            }
          } else {
          ...
          if (args) {
            ...
            if (e.tag === 5) {
              ...
              if (match) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */1], "Called 'car' on empty list"),
                        state
                      ];
              }
            } else if (args[1]) {
          ...
          if (args) {
            ...
            if (match.tag === 5) {
              ...
              if (match$1) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */1], "Called 'cdr' on empty list"),
                        state
                      ];
              }
            } else if (args[1]) {
              ...
              return /* tuple */[
                      Curry._1(Common.AST[/* create_exception */1], "Expected list in call to 'cdr'"),
                      state
                    ];
            }
          } else {
          ...
          if (args) {
            ...
            if (match) {
              ...
              if (match$1.tag === 5) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */1], "Expected list as second arg in call to 'cons'"),
                        state
                      ];
              }
            } else {
          ...
          if (args) {
            ...
            if (match.tag) {
              if (args[1]) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */1], "Expected ident in call to 'docs'"),
                        state
                      ];
              }
            } else if (args[1]) {
              ...
              if (match$1) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */1], "Undeclared identifier [" + (i + "].")),
                        state
                      ];
              }
            }
                ...
                if (args) {
                  ...
                  if (exit$1 === 2) {
                    if (args[1]) {
                      ...
                      return Curry._1(cb, /* tuple */[
                                  Curry._1(Common.AST[/* create_exception */1], "Expected list in call to 'DEBUG/expand-macro"),
                                  initial_state
                                ]);
                    }
                  }
...
function received_error(expected, args, name, state) {
  return /* tuple */[
          Curry._1(Common.AST[/* create_exception */1], "Received " + (Pervasives.string_of_int(List.length(args)) + (" arguments, expected " + (Pervasives.string_of_int(expected) + (" in call to '" + (name + "'")))))),
          state
        ];
}
...
function add_native_lambda(name, docs, is_macro, func, state) {
  ...
  var node = /* NativeFunc */Block.__(7, [/* record */[
        /* func */asyncf,
        /* is_macro */is_macro
      ]]);
...
},{"./common.js":4,"./evaluate.js":5,"bs-platform/lib/js/block.js":8,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/pervasives.js":37}],4:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function to_hashstring(ast) {
  switch (ast.tag | 0) {
    ...
    case 6 : 
        ...
        var scope_list = Curry._3(StringMap[/* fold */10], function (k, param, a) {
              return /* :: */[
                      k + param[1],
                      a
                    ];
...
function hash(node) {
  var s = to_hashstring(node);
  var hash$1 = 0;
  for(var i = 0 ,i_finish = s.length - 1 | 0; i <= i_finish; ++i){
    hash$1 = ((hash$1 << 5) - hash$1 | 0) + Caml_string.get(s, i) | 0;
  }
    ...
    switch (original_node.tag | 0) {
      case 0 : 
          ...
          if (match) {
            ...
            return Curry._1(cb, /* tuple */[
                        Curry._1(Common.AST[/* create_exception */1], "Undeclared identifier [" + (ident + "].")),
                        state
                      ]);
          }
      case 5 : 
...
function eval_lambda(called_func, args, func_name, ctx, state, cb) {
  if (ctx[/* depth */1] > 512) {
    return Curry._1(cb, /* tuple */[
                Curry._1(Common.AST[/* create_exception */1], "Stack overflow > " + Pervasives.string_of_int(512)),
                state
              ]);
  } else {
                  ...
                  case 6 : 
                      ...
                      if (match.tag) {
                        ...
                        if (arg_to_node_map.tag) {
                          return Curry._1(cb, /* tuple */[
                                      Curry._1(Common.AST[/* create_exception */1], arg_to_node_map[0]),
                                      state
                                    ]);
                        } else {
                          ...
                          var argsTable = Curry._2(Common.StringMapHelper[/* union */1], docarg_map, scope_map$1);
...
},{"./common.js":4,"bs-platform/lib/js/block.js":8,"bs-platform/lib/js/caml_builtin_exceptions.js":12,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/pervasives.js":37}],6:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
  ...
  while(true) {
    ...
    if (match) {
      ...
      if (typeof match$1 === "number") {
        return Curry._1(Common.AST[/* create_exception */1], "Unexpected end of input.");
      } else if (match$1.tag) {
        return Curry._1(Common.AST[/* create_exception */1], match$1[0]);
      } else {
        var match$2 = match$1[0];
        _acc = /* :: */[
          match$2[1],
...
function parse_single(s) {
  ...
  if (typeof match === "number") {
    ...
    return Curry._1(Common.AST[/* create_exception */1], match[0]);
  } else {
    var match$1 = match[0];
    var match$2 = peek(trim_comments(match$1[0]));
    if (match$2) {
      return Curry._1(Common.AST[/* create_exception */1], "Unexpected character [" + (append_char("", match$2[0]) + "]."));
    } else {
...
},{"./common.js":4,"bs-platform/lib/js/block.js":8,"bs-platform/lib/js/caml_builtin_exceptions.js":12,"bs-platform/lib/js/caml_format.js":16,"bs-platform/lib/js/caml_string.js":23,"bs-platform/lib/js/curry.js":29,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/string.js":40}],7:[function(require,module,exports){
'use strict';
