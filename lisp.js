...
var BuiltinFuncs = require("../../src/builtinFuncs.js");

var XHR = /* module */[];

function load_lib(filename, cb) {
  var xhr = new XMLHttpRequest();
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      return Curry._1(cb, /* Some */[xhr.responseText]);
    } else if (xhr.readyState === 4) {
      return Curry._1(cb, /* None */0);
    } else {
      return 0;
    }
  };
  xhr.open("GET", "stdlib/" + (filename + ".bot"), true);
  xhr.send();
  return /* () */0;
}

var Environment = /* module */[
  /* XHR */XHR,
  /* load_lib */load_lib
];

function scroll_bottom(obj) {
...
var Builtins = BuiltinFuncs.Builtins([load_lib]);

function process_input(state, cb, in_str) {
  var e = Curry._1(Parse.Parser[/* parse_single */10], in_str);
  if (e.tag) {
    ...
    return Curry._4(Evaluate.Eval[/* eval */9], e[0], Curry._1(Evaluate.Eval[/* create_initial_context */2], state), state, cb);
  }
}
...
function add_console_element(inner_text) {
  var pre_node = document.createElement("pre");
  var new_node = document.createElement("div");
  new_node.innerHTML = inner_text;
  pre_node.appendChild(new_node);
  console_element.appendChild(pre_node);
  return scroll_bottom(console_element);
}

var state = [Curry._1(Builtins[/* add_builtins */3], Evaluate.Eval[/* empty */0])];

var evaluating = [/* false */0];
...
function moveHistory(by) {
  var new_pos = position[0] + by | 0;
  if (new_pos < 1 || new_pos > List.length(history[0])) {
    return /* None */0;
  } else {
    position[0] = new_pos;
    return /* Some */[List.nth(history[0], new_pos - 1 | 0)];
  }
}

input_element.onkeydown = function (e) {
  var match = e.keyCode;
  if (match >= 38) {
    if (match >= 41) {
      return true;
      ...
      switch (match - 38 | 0) {
        case 0 : 
            var match$1 = moveHistory(1);
            if (match$1) {
              input_element.value = match$1[0];
              return false;
            } else {
              return false;
            }
        case 1 : 
            return true;
        case 2 : 
            var match$2 = moveHistory(-1);
            if (match$2) {
              input_element.value = match$2[0];
              return false;
            } else {
              return false;
            }
    ...
    var in_str = input_element.value;
    evaluating[0] = /* true */1;
    history[0] = /* :: */[
      in_str,
      history[0]
    ...
    process_input(state[0], function (param) {
          ...
          state[0] = /* record */[
            /* userTable */new_state[/* userTable */0],
            /* symbolTable */new_state[/* symbolTable */1],
            /* uuidToNodeMap */new_state[/* uuidToNodeMap */2],
            /* refMap */new_state[/* refMap */3],
            /* recentActions : [] */0
          ];
          input_element.value = "";
          add_console_element("> " + in_str);
          return add_console_element(Stringify.string_of_ast(param[0], new_state));
        }, in_str);
    return false;
  }
};
...
exports.scroll_bottom       = scroll_bottom;
exports.AST                 = AST;
exports.Eval                = Eval;
exports.Builtins            = Builtins;
exports.process_input       = process_input;
exports.input_element       = input_element;
exports.console_element     = console_element;
exports.setMonospaced       = setMonospaced;
exports.add_console_element = add_console_element;
exports.state               = state;
exports.evaluating          = evaluating;
exports.history             = history;
exports.position            = position;
exports.moveHistory         = moveHistory;
/*  Not a pure module */

},{"../../src/builtinFuncs.js":2,"../../src/evaluate.js":5,"../../src/parse.js":7,"../../src/stringify.js":8,"bs-platform/lib/js/curry.js":32,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/random.js":42}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
var BuiltinHelper           = require("./builtinHelper.js");
var Caml_builtin_exceptions = require("bs-platform/lib/js/caml_builtin_exceptions.js");

function Builtins(Environment) {
  var add_builtins = function (state) {
    var do_operation = function (op, op_name, state) {
      return BuiltinHelper.add_native_lambda(op_name, /* None */0, /* false */0, function (args, _, state) {
                  var $js;
                  if (args) {
                    var hd = args[0];
                    if (hd.tag === 2) {
                      var res = List.fold_left(function (acc, v) {
                            var exit = 0;
                            if (acc.tag) {
                              return acc;
                            } else {
                              ...
                              if (match.tag === 2) {
                                if (v.tag === 2) {
                                  return /* Ok */Block.__(0, [/* Num */Block.__(2, [Curry._2(op, match[0], v[0])])]);
                                } else {
                                  exit = 1;
                                }
                              } else {
                            ...
                            if (exit === 1) {
                              return Curry._1(Common.AST[/* create_exception */0], "Called '" + (op_name + "' with something not a number."));
                            }
                            
                          }, /* Ok */Block.__(0, [hd]), args[1]);
                      $js = res.tag ? /* Error */Block.__(1, [res[0]]) : /* Ok */Block.__(0, [res[0]]);
                    } else {
                      $js = Curry._1(Common.AST[/* create_exception */0], "Called '" + (op_name + "' with something not a number."));
                    }
                  } else {
                    $js = Curry._1(Common.AST[/* create_exception */0], "Called '" + (op_name + "' with no args."));
                  }
                  return /* tuple */[
                          $js,
                          state
    ...
    var state$1 = do_operation(function (prim, prim$1) {
          return prim + prim$1;
        }, "+", state);
    var state$2 = do_operation(function (prim, prim$1) {
          return prim - prim$1;
        }, "-", state$1);
    var state$3 = do_operation(function (prim, prim$1) {
          return prim / prim$1;
        }, "/", state$2);
    var state$4 = do_operation(function (prim, prim$1) {
          return prim * prim$1;
        }, "*", state$3);
    var create_lambda_scope = function (node, map, arg_names, ctx, state) {
      switch (node.tag | 0) {
        case 0 : 
            var i = node[0];
            var match = Curry._3(Evaluate.Eval[/* resolve_ident_with_docs */6], i, ctx, state);
            if (match) {
              var match$1 = match[0];
              var node$1 = match$1[1];
              if (node$1.tag === 8) {
                ...
                var hash = Hash.hash(node$1);
                var new_state = Curry._3(Evaluate.Eval[/* add_to_uuid_map */8], state, hash, node$1);
                return /* Ok */Block.__(0, [/* tuple */[
                            Curry._3(Common.StringMap[/* add */3], i, /* tuple */[
                                  match$1[0],
                                  hash
                                ], map),
                            new_state
        ...
        case 5 : 
            return List.fold_left(function (acc, v) {
                        if (acc.tag) {
                          ...
                          var match = acc[0];
                          return create_lambda_scope(v, match[0], arg_names, ctx, match[1]);
                        }
                      }, /* Ok */Block.__(0, [/* tuple */[
                            map,
                            state
    ...
    var parse_lambda_args = function (_args, _acc) {
      while(true) {
        ...
        if (args) {
          var match = args[0];
          if (match.tag) {
            return /* Error */Block.__(1, ["Argument defined as not identifier in function definition."]);
          } else {
            var ident = match[0];
            if (ident === "...") {
              var match$1 = args[1];
    ...
    var create_lambda_func = function (is_macro, args, ctx, state) {
        ...
        if (match.tag === 5) {
          ...
          if (match$1) {
            if (match$1[1]) {
              ...
              var body = match$1[0];
              var arg_names = parse_lambda_args(match[0], /* [] */0);
              if (arg_names.tag) {
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */0], arg_names[0]),
                        state
                      ];
              } else {
                var match$2 = arg_names[0];
                var vararg = match$2[1];
                var names = match$2[0];
                var match$3 = create_lambda_scope(body, Common.StringMap[/* empty */0], names, ctx, state);
                if (match$3.tag) {
                  return /* tuple */[
                          Curry._1(Common.AST[/* create_exception */0], match$3[0]),
                          state
                        ];
                } else {
                  var match$4 = match$3[0];
                  var idents = match$4[0];
                  var node_dummy = /* Func */Block.__(7, [/* record */[
                        /* func */body,
                        /* args */names,
                        /* vararg */vararg,
                        /* scope */idents,
                  ...
                  var hash = Hash.hash(node_dummy);
                  var node = /* Func */Block.__(7, [/* record */[
                        /* func */body,
                        /* args */names,
                        /* vararg */vararg,
                        /* scope */idents,
                  ...
                  var new_state = Curry._3(Evaluate.Eval[/* add_to_uuid_map */8], match$4[1], hash, node);
                  return /* tuple */[
                          /* Ok */Block.__(0, [node]),
                          new_state
                        ];
          ...
          if (match$5) {
            if (match$5[1]) {
              ...
              return /* tuple */[
                      Curry._1(Common.AST[/* create_exception */0], "Expected list as first argument in call to '" + (func_name + "'")),
                      state
                    ];
            }
          } else {
      ...
      if (exit === 1) {
        return BuiltinHelper.received_error(2, args, func_name, state);
      }
      
    };
    var state$5 = BuiltinHelper.add_native_lambda("lambda", /* None */0, /* true */1, function (param, param$1, param$2) {
          return create_lambda_func(/* false */0, param, param$1, param$2);
        }, state$4);
    var state$6 = BuiltinHelper.add_native_lambda("macro", /* None */0, /* true */1, function (param, param$1, param$2) {
          return create_lambda_func(/* true */1, param, param$1, param$2);
        }, state$5);
    var state$7 = BuiltinHelper.add_native_lambda("throw", /* None */0, /* false */0, function (args, _, state) {
          if (args) {
            if (args[1]) {
              return BuiltinHelper.received_error(2, args, "throw", state);
            } else {
              return /* tuple */[
    ...
    var state$8 = BuiltinHelper.add_native_lambda_async("try", /* None */0, /* true */1, function (args, ctx, state, $$return) {
          var exit = 0;
          if (args) {
            var match = args[1];
            if (match) {
              if (match[1]) {
                ...
                var lambda = match[0];
                return Curry._4(Evaluate.Eval[/* eval */9], args[0], ctx, state, function (x) {
                            var match = x[0];
                            if (match.tag) {
                              var ex = match[0][1];
                              return Curry._4(Evaluate.Eval[/* eval */9], lambda, ctx, x[1], function (param) {
                                          var match = param[0];
                                          var exit = 0;
                                          if (match.tag) {
                                            exit = 1;
                                            ...
                                            if (exit$1 === 2) {
                                              return Curry._6(Evaluate.Eval[/* eval_lambda */10], func, /* :: */[
                                                          ex,
                                                          /* [] */0
                                                        ], "[Try]", ctx, param[1], $$return);
                                            }
                                            
                                          }
                                          if (exit === 1) {
                                            return Curry._1($$return, /* tuple */[
                                                        Curry._1(Common.AST[/* create_exception */0], "Expected lambda as second argument in call to 'try'"),
                                                        param[1]
                                                      ]);
                                          }
          ...
          if (exit === 1) {
            return Curry._1($$return, BuiltinHelper.received_error(2, args, "try", state));
          }
          
        }, state$7);
    var state$9 = BuiltinHelper.add_native_lambda_async("define", /* Some */["Takes an identifier and a value to be set to that identifier. Optionally, a string can be passed in after the identifier to be used as docs."], /* true */1, function (args, ctx, state, $$return) {
          var exit = 0;
          var ident;
          var other;
          if (args) {
            ...
            if (match.tag) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */0], "Expected ident as first argument in call to 'define'"),
                              state
                            ]);
                }
              } else {
          ...
          switch (exit) {
            case 1 : 
                return Curry._1($$return, BuiltinHelper.received_error(2, args, "define", state));
            case 2 : 
                var docs;
                if (args) {
                  var match$4 = args[1];
                  if (match$4) {
                    ...
                    if (match$5.tag === 1) {
                      ...
                      docs = match$6 && !match$6[1] ? /* Some */[match$5[0]] : /* None */0;
                    } else {
                      docs = /* None */0;
                    }
                  } else {
                ...
                if (ctx[/* depth */1] > 2) {
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */0], "Can only define at the top level"),
                              state
                            ]);
                } else if (Curry._2(Evaluate.Eval[/* is_reserved_symbol */7], state, ident)) {
                  return Curry._4(Evaluate.Eval[/* eval */9], other, ctx, state, function (e) {
                              var match = e[0];
                              if (match.tag) {
                                return Curry._1($$return, e);
                              } else {
                                var res = match[0];
                                if (res.tag === 8) {
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */0], "Cannot rename builtin function."),
                                              state
                                            ]);
                                } else {
                                  return Curry._1($$return, /* tuple */[
                                              /* Ok */Block.__(0, [/* List */Block.__(5, [/* [] */0])]),
                                              Curry._4(Evaluate.Eval[/* define_user_symbol */4], e[1], ident, docs, res)
                                            ]);
                                }
                              }
                            });
                  ...
                  return Curry._1($$return, /* tuple */[
                              Curry._1(Common.AST[/* create_exception */0], "Cannot define reserved keyword [" + (ident + "].")),
                              state
                            ]);
                }
    ...
    var state$10 = BuiltinHelper.add_native_lambda("quote", /* None */0, /* true */1, function (args, _, state) {
          if (args) {
            if (args[1]) {
              return BuiltinHelper.received_error(1, args, "quote", state);
            } else {
              return /* tuple */[
                      /* Ok */Block.__(0, [args[0]]),
                      state
                    ];
            }
          } else {
    ...
    var state$11 = BuiltinHelper.add_native_lambda_async("unquote", /* None */0, /* true */1, function (args, ctx, state, $$return) {
          if (args) {
            if (args[1]) {
              return Curry._1($$return, BuiltinHelper.received_error(1, args, "unquote", state));
            } else {
              return Curry._4(Evaluate.Eval[/* eval */9], args[0], ctx, state, $$return);
            }
          } else {
            return Curry._1($$return, BuiltinHelper.received_error(1, args, "unquote", state));
          }
        }, state$10);
    var traverseH = function (lst, acc, ctx, state, $$return) {
      if (lst) {
        var tl = lst[1];
        var v = lst[0];
        var exit = 0;
        if (v.tag === 5) {
          ...
          if (match) {
            ...
            if (match$1.tag) {
              exit = 1;
            } else if (match$1[0] === "unquote-splice") {
              var match$2 = match[1];
              if (match$2) {
                if (match$2[1]) {
                  exit = 1;
                } else {
                  return Curry._4(Evaluate.Eval[/* eval */9], match$2[0], ctx, state, function (param) {
                              var state = param[1];
                              var res = param[0];
                              if (res.tag) {
                                return Curry._1($$return, /* tuple */[
                                ...
                                var match = res[0];
                                if (match.tag === 5) {
                                  return traverseH(tl, Pervasives.$at(acc, match[0]), ctx, state, $$return);
                                } else {
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */0], "'unquote-splice' only applies to lists"),
                                              state
                                            ]);
                                }
                              }
        ...
        if (exit === 1) {
          return traverse(v, ctx, state, function (param) {
                      var state = param[1];
                      var res = param[0];
                      if (res.tag) {
                        return Curry._1($$return, /* tuple */[
                        ...
                        return traverseH(tl, Pervasives.$at(acc, /* :: */[
                                        res[0],
                                        /* [] */0
                                      ]), ctx, state, $$return);
                      }
    ...
    var traverse = function (node, ctx, state, $$return) {
      if (node.tag === 5) {
        var lst = node[0];
        var exit = 0;
        if (lst) {
          ...
          if (match.tag) {
            exit = 1;
          } else if (match[0] === "unquote") {
            var lst$1 = lst[1];
            if (lst$1) {
              if (lst$1[1]) {
                return Curry._1($$return, BuiltinHelper.received_error(1, lst$1, "unquote", state));
              } else {
                return Curry._4(Evaluate.Eval[/* eval */9], lst$1[0], ctx, state, $$return);
              }
            } else {
              return Curry._1($$return, BuiltinHelper.received_error(1, lst$1, "unquote", state));
            }
        ...
        if (exit === 1) {
          return traverseH(lst, /* [] */0, ctx, state, function (param) {
                      var match = param[0];
                      if (match.tag) {
                        return Curry._1($$return, /* tuple */[
                                    /* Error */Block.__(1, [match[0]]),
                                    param[1]
                                  ]);
                      } else {
                        return Curry._1($$return, /* tuple */[
                                    /* Ok */Block.__(0, [/* List */Block.__(5, [match[0]])]),
                                    param[1]
                                  ]);
                      }
                    });
    ...
    var state$12 = BuiltinHelper.add_native_lambda_async("syntax-quote", /* None */0, /* true */1, function (args, ctx, state, $$return) {
          if (args) {
            if (args[1]) {
              return Curry._1($$return, BuiltinHelper.received_error(1, args, "syntax-quote", state));
            } else {
              return traverse(args[0], ctx, state, $$return);
            }
          } else {
            return Curry._1($$return, BuiltinHelper.received_error(1, args, "syntax-quote", state));
          }
        }, state$11);
    var state$13 = BuiltinHelper.add_native_lambda_async("if", /* None */0, /* true */1, function (args, ctx, state, $$return) {
          var exit = 0;
          if (args) {
            var match = args[1];
            if (match) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  var alternate = match$1[0];
                  var consequent = match[0];
                  return Curry._4(Evaluate.Eval[/* eval */9], args[0], ctx, state, function (evaled_cond) {
                              var match = evaled_cond[0];
                              if (match.tag) {
                                return Curry._1($$return, evaled_cond);
                              } else {
                                var match$1 = match[0];
                                if (match$1.tag === 3) {
                                  if (match$1[0] !== 0) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              Curry._1(Common.AST[/* create_exception */0], "First argument to 'if' must evaluate to boolean."),
                                              evaled_cond[1]
                                            ]);
                                }
                              }
          ...
          if (exit === 1) {
            return Curry._1($$return, BuiltinHelper.received_error(3, args, "if", state));
          }
          
        }, state$12);
    var eval_list = function (lst, state, ctx, $$return) {
      if (lst) {
        var tl = lst[1];
        return Curry._4(Evaluate.Eval[/* eval */9], lst[0], ctx, state, function (param) {
                    var match = param[0];
                    if (match.tag) {
                      return Curry._1($$return, /* Error */Block.__(1, [match[0]]));
                    } else {
                      var state = param[1];
                      return eval_list(tl, state, Curry._1(Evaluate.Eval[/* create_initial_context */2], state), $$return);
                    }
                  });
      } else {
        return Curry._1($$return, /* Ok */Block.__(0, [state]));
      }
    };
    var state$14 = BuiltinHelper.add_native_lambda_async("load", /* None */0, /* false */0, function (args, ctx, state, $$return) {
          var exit = 0;
          if (args) {
            var match = args[0];
            if (match.tag === 1) {
              if (args[1]) {
                ...
                var lib_name = match[0];
                return Curry._2(Environment[/* load_lib */0], lib_name, function (text) {
                            if (text) {
                              var match = Curry._1(Parse.Parser[/* parse_multi */8], $$String.trim(text[0]));
                              if (match.tag) {
                                return Curry._1($$return, /* tuple */[
                                            /* Error */Block.__(1, [match[0]]),
                                            state
                                ...
                                return eval_list(match[0], state, ctx, function (param) {
                                            if (param.tag) {
                                              return Curry._1($$return, /* tuple */[
                                                          /* Error */Block.__(1, [param[0]]),
                                                          state
                                                        ]);
                                            } else {
                                              return Curry._1($$return, /* tuple */[
                              ...
                              return Curry._1($$return, /* tuple */[
                                          Curry._1(Common.AST[/* create_exception */0], "Could not load lib " + lib_name),
                                          state
                                        ]);
                            }
                          });
              ...
              return Curry._1($$return, /* tuple */[
                          Curry._1(Common.AST[/* create_exception */0], "Expected string as first argument in call to 'load'"),
                          state
                        ]);
            }
          } else {
          ...
          if (exit === 1) {
            return Curry._1($$return, BuiltinHelper.received_error(1, args, "load", state));
          }
          
        }, state$13);
    var equal_helper = function (_v1, _v2) {
      while(true) {
        var v2 = _v2;
        var v1 = _v1;
        if (Caml_obj.caml_equal(v1, v2)) {
          ...
          switch (v1.tag | 0) {
            ...
            case 3 : 
                if (v2.tag === 3) {
                  return Caml_obj.caml_equal(v1[0], v2[0]);
                } else {
                  return /* false */0;
                }
                break;
            ...
            case 5 : 
                if (v2.tag === 5) {
                  try {
                    return List.fold_left2(function (acc, e1, e2) {
                                if (acc) {
                                  return /* true */1;
                                } else {
                                  return equal_helper(e1, e2);
                                }
                              }, /* true */1, v1[0], v2[0]);
                  }
                  catch (raw_exn){
            ...
            case 7 : 
                if (v2.tag === 7) {
                  var match = v2[0];
                  var match$1 = v1[0];
                  if (Caml_obj.caml_equal(match$1[/* is_macro */5], match[/* is_macro */5])) {
                    if (Caml_obj.caml_equal(match$1[/* args */1], match[/* args */1])) {
                      if (Caml_obj.caml_equal(match$1[/* vararg */2], match[/* vararg */2])) {
                        if (Caml_obj.caml_equal(match$1[/* scope */3], match[/* scope */3])) {
                          _v2 = match[/* func */0];
                          _v1 = match$1[/* func */0];
                          continue ;
    ...
    var state$15 = BuiltinHelper.add_native_lambda("=", /* None */0, /* false */0, function (args, _, state) {
          var exit = 0;
          if (args) {
            var match = args[1];
            if (match) {
              if (match[1]) {
                ...
                return /* tuple */[
                        /* Ok */Block.__(0, [/* Bool */Block.__(3, [equal_helper(args[0], match[0])])]),
                        state
                      ];
              }
            } else {
          ...
          if (exit === 1) {
            return BuiltinHelper.received_error(2, args, "equal?", state);
          }
          
        }, state$14);
    var state$16 = BuiltinHelper.add_native_lambda("car", /* None */0, /* false */0, function (args, _, state) {
          var exit = 0;
          if (args) {
            var e = args[0];
            if (e.tag === 5) {
              ...
              if (match) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */0], "Called 'car' on empty list"),
                        state
                      ];
              }
            } else if (args[1]) {
              ...
              return /* tuple */[
                      Curry._1(Common.AST[/* create_exception */0], "Expected list in call to 'car', got [" + (Stringify.string_of_ast(/* Ok */Block.__(0, [e]), state) + "] instead.")),
                      state
                    ];
            }
          } else {
          ...
          if (exit === 1) {
            return BuiltinHelper.received_error(1, args, "car", state);
          }
          
        }, state$15);
    var state$17 = BuiltinHelper.add_native_lambda("cdr", /* None */0, /* false */0, function (args, _, state) {
          var exit = 0;
          if (args) {
            var match = args[0];
            if (match.tag === 5) {
              ...
              if (match$1) {
                if (args[1]) {
                  ...
                  return /* tuple */[
                          /* Ok */Block.__(0, [/* List */Block.__(5, [match$1[1]])]),
                          state
                        ];
                }
              } else if (args[1]) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */0], "Called 'cdr' on empty list"),
                        state
                      ];
              }
            } else if (args[1]) {
              ...
              return /* tuple */[
                      Curry._1(Common.AST[/* create_exception */0], "Expected list in call to 'cdr'"),
                      state
                    ];
            }
          } else {
          ...
          if (exit === 1) {
            return BuiltinHelper.received_error(1, args, "cdr", state);
          }
          
        }, state$16);
    var state$18 = BuiltinHelper.add_native_lambda("cons", /* None */0, /* false */0, function (args, _, state) {
          var exit = 0;
          if (args) {
            var match = args[1];
            if (match) {
              ...
              if (match$1.tag === 5) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */0], "Expected list as second arg in call to 'cons'"),
                        state
                      ];
              }
            } else {
          ...
          if (exit === 1) {
            return BuiltinHelper.received_error(2, args, "cons", state);
          }
          
        }, state$17);
    var state$19 = BuiltinHelper.add_native_lambda("docs", /* None */0, /* true */1, function (args, ctx, state) {
          var exit = 0;
          if (args) {
            var match = args[0];
            if (match.tag) {
              if (args[1]) {
                ...
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */0], "Expected ident in call to 'docs'"),
                        state
                      ];
              }
            } else if (args[1]) {
              ...
              var i = match[0];
              var match$1 = Curry._3(Evaluate.Eval[/* resolve_ident_with_docs */6], i, ctx, state);
              if (match$1) {
                var match$2 = match$1[0][0];
                if (match$2) {
                  return /* tuple */[
                          /* Ok */Block.__(0, [/* Str */Block.__(1, [match$2[0]])]),
                          state
                        ];
                } else {
                  return /* tuple */[
                          /* Ok */Block.__(0, [/* Str */Block.__(1, ["No docs"])]),
                          state
                        ];
                }
              } else {
                return /* tuple */[
                        Curry._1(Common.AST[/* create_exception */0], "Undeclared identifier [" + (i + "].")),
                        state
                      ];
              }
            }
          ...
          if (exit === 1) {
            return BuiltinHelper.received_error(1, args, "docs", state);
          }
            ...
            if (match.tag === 4) {
              if (args[1]) {
                ...
                if (match$1) {
                  ...
                  $js = match$2 ? /* Ok */Block.__(0, [match$2[0]]) : Curry._1(Common.AST[/* create_exception */0], "Cannot find uuid");
                } else {
                  $js = Curry._1(Common.AST[/* create_exception */0], "Cannot find refID");
                }
                return /* tuple */[
                        $js,
                        state
    ...
    var state$23 = BuiltinHelper.add_native_lambda("Map.make", /* None */0, /* false */0, function (args, _, state) {
          if (args) {
            return BuiltinHelper.received_error(0, args, "Map.make", state);
          } else {
            return /* tuple */[
                    /* Ok */Block.__(0, [/* Map */Block.__(6, [Common.ASTMap[/* empty */0]])]),
                    state
                  ];
          }
        }, state$22);
    var state$24 = BuiltinHelper.add_native_lambda("Map.get", /* None */0, /* false */0, function (args, _, state) {
          var exit = 0;
          if (args) {
            var match = args[0];
            if (match.tag === 6) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  var v;
                  try {
                    v = Curry._2(Common.ASTMap[/* find */21], key, match[0]);
                    exit$1 = 2;
                  }
                  catch (exn){
                    return /* tuple */[
                            Curry._1(Common.AST[/* create_exception */0], "Could not find key: " + Stringify.string_of_ast(/* Ok */Block.__(0, [key]), state)),
                            state
                          ];
                  }
                  if (exit$1 === 2) {
          ...
          if (exit === 1) {
            return BuiltinHelper.received_error(2, args, "Map.get", state);
          }
          
        }, state$23);
    var state$25 = BuiltinHelper.add_native_lambda("Map.add", /* None */0, /* false */0, function (args, _, state) {
          var exit = 0;
          if (args) {
            var match = args[0];
            if (match.tag === 6) {
              ...
              if (match$1) {
                ...
                if (match$2) {
                  if (match$2[1]) {
                    ...
                    return /* tuple */[
                            /* Ok */Block.__(0, [/* Map */Block.__(6, [Curry._3(Common.ASTMap[/* add */3], match$1[0], match$2[0], match[0])])]),
                            state
                          ];
                  }
                } else {
          ...
          if (exit === 1) {
            return BuiltinHelper.received_error(3, args, "Map.add", state);
          }
          
        }, state$24);
    var state$26 = BuiltinHelper.add_native_lambda("Map.remove", /* None */0, /* false */0, function (args, _, state) {
          var exit = 0;
          if (args) {
            var match = args[0];
            if (match.tag === 6) {
              ...
              if (match$1) {
                if (match$1[1]) {
                  ...
                  return /* tuple */[
                          /* Ok */Block.__(0, [/* Map */Block.__(6, [Curry._2(Common.ASTMap[/* remove */5], match$1[0], match[0])])]),
                          state
                        ];
                }
              } else {
          ...
          if (exit === 1) {
            return BuiltinHelper.received_error(2, args, "Map.remove", state);
          }
                ...
                if (args) {
                      ...
                      if (args[1]) {
                        ...
                        return Curry._4(Evaluate.Eval[/* eval */9], match$1[0], ctx, initial_state, function (param) {
                                    ...
                                    if (evaled_first.tag) {
                                      ...
                                      if (exit$1 === 2) {
                                        return Curry._1(cb, /* tuple */[
                                                    Curry._1(Common.AST[/* create_exception */0], Stringify.string_of_ast(evaled_first, state)),
                                                    initial_state
                                                  ]);
                                      }
                  ...
                  if (exit$1 === 2) {
                    if (args[1]) {
                      ...
                      return Curry._1(cb, /* tuple */[
                                  Curry._1(Common.AST[/* create_exception */0], "Expected list in call to 'DEBUG/expand-macro"),
                                  initial_state
                                ]);
                    }
                  }
...
},{"./builtinHelper.js":3,"./common.js":4,"./evaluate.js":5,"./hash.js":6,"./parse.js":7,"./stringify.js":8,"bs-platform/lib/js/block.js":10,"bs-platform/lib/js/caml_builtin_exceptions.js":14,"bs-platform/lib/js/caml_obj.js":25,"bs-platform/lib/js/curry.js":32,"bs-platform/lib/js/js_exn.js":36,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/pervasives.js":40,"bs-platform/lib/js/string.js":43}],3:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function received_error(expected, args, name, state) {
  return /* tuple */[
          Curry._1(Common.AST[/* create_exception */0], "Received " + (Pervasives.string_of_int(List.length(args)) + (" arguments, expected " + (Pervasives.string_of_int(expected) + (" in call to '" + (name + "'")))))),
          state
        ];
}

function add_native_lambda(name, docs, is_macro, func, state) {
  var asyncf = function (args, ctx, state, cb) {
    return Curry._1(cb, Curry._3(func, args, ctx, state));
  };
  var node = /* NativeFunc */Block.__(8, [/* record */[
        /* func */asyncf,
        /* is_macro */is_macro
      ]]);
  return Curry._4(Evaluate.Eval[/* define_native_symbol */3], state, name, docs, node);
}

function add_native_lambda_async(name, docs, is_macro, func, state) {
  var node = /* NativeFunc */Block.__(8, [/* record */[
        /* func */func,
        /* is_macro */is_macro
      ]]);
...
exports.received_error          = received_error;
exports.add_native_lambda       = add_native_lambda;
exports.add_native_lambda_async = add_native_lambda_async;
/* Common Not a pure module */

},{"./common.js":4,"./evaluate.js":5,"bs-platform/lib/js/block.js":10,"bs-platform/lib/js/curry.js":32,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/pervasives.js":40}],4:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function get(key, map) {
  try {
    return /* Some */[Curry._2(StringMap[/* find */21], key, map)];
  }
  catch (exn){
    return /* None */0;
  }
...
function get_default(key, map, $$default) {
  try {
...
function update_default(key, map, $$default, update) {
  var curr_v;
  try {
    curr_v = Curry._2(StringMap[/* find */21], key, map);
  }
  catch (exn){
    curr_v = $$default;
  }
  return Curry._3(StringMap[/* add */3], key, Curry._1(update, curr_v), map);
}

function union(m1, m2) {
  return Curry._3(StringMap[/* merge */6], function (_, v1, v2) {
              if (v1) {
                return /* Some */[v1[0]];
              } else if (v2) {
                return /* Some */[v2[0]];
...
var empty_000 = /* userTable */StringMap[/* empty */0];

var empty_001 = /* symbolTable */StringMap[/* empty */0];
...
function update_ref(ref_id, new_val, state) {
  return /* record */[
          ...
          /* recentActions : :: */[
            /* UpdateRef */Block.__(1, [/* tuple */[
                  ref_id,
                  new_val
                ]]),
            state[/* recentActions */4]
          ]
        ];
}
...
function add_to_uuidmap(node, uuid, state) {
  return /* record */[
          ...
          /* recentActions : :: */[
            /* AddUuid */Block.__(0, [uuid]),
            state[/* recentActions */4]
          ]
        ];
}

function add_to_symboltable(ident_name, node, state) {
  return /* record */[
          /* userTable */state[/* userTable */0],
          /* symbolTable */Curry._3(StringMap[/* add */3], ident_name, node, state[/* symbolTable */1]),
          /* uuidToNodeMap */state[/* uuidToNodeMap */2],
          /* refMap */state[/* refMap */3],
          /* recentActions */state[/* recentActions */4]
        ];
}

function add_to_usertable(ident_name, uuid, state) {
  return /* record */[
...
function ASTFunc() {
  var create_exception = function (text) {
    return /* Error */Block.__(1, [/* tuple */[
                /* [] */0,
                /* Str */Block.__(1, [text])
              ]]);
  };
  return /* module */[/* create_exception */create_exception];
}

var AST = Caml_module.init_mod([
      "/Users/schmave/Documents/git/relisp-bot/src/Common.re",
      173,
      62
    ], [[0]]);
...
var ASTMap = $$Map.Make(/* module */[/* compare */compare]);

function create_exception(text) {
  return /* Error */Block.__(1, [/* tuple */[
              /* [] */0,
              /* Str */Block.__(1, [text])
            ]]);
...
Caml_module.update_mod([[0]], AST, /* module */[/* create_exception */create_exception]);

exports.gen_uuid        = gen_uuid;
exports.StringMap       = StringMap;
exports.StringMapHelper = StringMapHelper;
exports.EvalState       = EvalState;
exports.ASTFunc         = ASTFunc;
exports.AST             = AST;
exports.ASTMap          = ASTMap;
/* StringMap Not a pure module */

},{"bs-platform/lib/js/block.js":10,"bs-platform/lib/js/caml_module.js":24,"bs-platform/lib/js/caml_obj.js":25,"bs-platform/lib/js/curry.js":32,"bs-platform/lib/js/map.js":38,"bs-platform/lib/js/printf.js":41,"bs-platform/lib/js/random.js":42,"bs-platform/lib/js/string.js":43}],5:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
var empty = Common.EvalState[/* empty */0];

function is_macro(func) {
  switch (func.tag | 0) {
    case 7 : 
        return func[0][/* is_macro */5];
    case 8 : 
        return func[0][/* is_macro */1];
    default:
      return /* false */0;
  }
}

function wrap_in_uuid(param) {
  return /* tuple */[
          param[0],
          /* Uuid */Block.__(0, [param[1]])
        ];
}

function create_initial_context(state) {
  return /* record */[
          /* argsTable */Curry._2(Common.StringMap[/* map */22], wrap_in_uuid, state[/* userTable */0]),
          /* depth */0
        ];
}
...
function is_reserved_symbol(state, ident_name) {
  return +(Curry._2(Common.StringMapHelper[/* get */0], ident_name, state[/* symbolTable */1]) === /* None */0);
}
...
function resolve_ident_with_docs(ident_name, ctx, state) {
  var match = Curry._2(Common.StringMapHelper[/* get */0], ident_name, state[/* symbolTable */1]);
  if (match) {
    return /* Some */[match[0]];
  } else {
    var match$1 = Curry._2(Common.StringMapHelper[/* get */0], ident_name, ctx[/* argsTable */0]);
    if (match$1) {
      var match$2 = match$1[0];
      var match$3 = match$2[1];
      var docs = match$2[0];
      if (match$3.tag) {
        ...
        var match$4 = Curry._2(Common.StringMapHelper[/* get */0], match$3[0], state[/* uuidToNodeMap */2]);
        if (match$4) {
          return /* Some */[/* tuple */[
                    docs,
                    match$4[0]
          ...
          return Pervasives.failwith("Could not find node " + (ident_name + " in uuidMap"));
        }
      }
    } else {
      return /* None */0;
...
function resolve_ident(ident_name, ctx, state) {
  var match = resolve_ident_with_docs(ident_name, ctx, state);
  if (match) {
...
function create_lambda_arg_map(vararg, _func_args, _passed_args, _map) {
  while(true) {
    var map = _map;
    var passed_args = _passed_args;
    var func_args = _func_args;
    if (func_args) {
      if (passed_args) {
        _map = Curry._3(Common.StringMap[/* add */3], func_args[0], /* Node */Block.__(1, [passed_args[0]]), map);
        _passed_args = passed_args[1];
        _func_args = func_args[1];
        continue ;
        
      } else {
        var received = Curry._1(Common.StringMap[/* cardinal */15], map);
        var match = List.rev(func_args);
        var $js;
        $js = match ? (
            match[0] === "..." ? List.length(match[1]) - 1 | 0 : List.length(func_args)
          ) : List.length(func_args);
        var expected = $js + received | 0;
        return /* Error */Block.__(1, ["Expected " + (Pervasives.string_of_int(expected) + (" arguments, received " + (Pervasives.string_of_int(received) + " arguments.")))]);
      }
    } else {
      var exit = 0;
      if (passed_args) {
      ...
      if (exit === 1) {
        if (vararg) {
          return /* Ok */Block.__(0, [Curry._3(Common.StringMap[/* add */3], vararg[0], /* Node */Block.__(1, [/* List */Block.__(5, [passed_args])]), map)]);
        } else {
          var expected$1 = Curry._1(Common.StringMap[/* cardinal */15], map);
          var received$1 = expected$1 + List.length(passed_args) | 0;
          return /* Error */Block.__(1, ["Expected " + (Pervasives.string_of_int(expected$1) + (" arguments, received " + (Pervasives.string_of_int(received$1) + " arguments.")))]);
        }
      }
...
function $$eval(_original_node, ctx, state, _cb) {
  while(true) {
    var cb = _cb;
    var original_node = _original_node;
    switch (original_node.tag | 0) {
      case 0 : 
          var ident = original_node[0];
          var match = resolve_ident(ident, ctx, state);
          if (match) {
            return Curry._1(cb, /* tuple */[
                        /* Ok */Block.__(0, [match[0]]),
                        state
            ...
            return Curry._1(cb, /* tuple */[
                        Curry._1(Common.AST[/* create_exception */0], "Undeclared identifier [" + (ident + "].")),
                        state
                      ]);
          }
      case 5 : 
          var lst = original_node[0];
          if (lst) {
            var args = lst[1];
            var first = lst[0];
            var name;
              ...
              if (evaled_first.tag) {
                ...
                switch (func$2.tag | 0) {
                  ...
                  case 8 : 
                      ...
                      break;
                  default:
                    var node_str = Stringify.string_of_ast(/* Ok */Block.__(0, [func$2]), state);
                    return Curry._1(cb, /* tuple */[
                                Curry._1(Common.AST[/* create_exception */0], "Trying to call something that isn't a function. [" + (node_str + "]")),
                                state
                              ]);
                }
              }
...
function eval_lambda(called_func, args, func_name, ctx, state, cb) {
  if (ctx[/* depth */1] > 512) {
    return Curry._1(cb, /* tuple */[
                Curry._1(Common.AST[/* create_exception */0], "Stack overflow > " + Pervasives.string_of_int(512)),
                state
              ]);
  } else {
    return eval_args(called_func, args, ctx, state, /* [] */0, function (maybe_args) {
                switch (called_func.tag | 0) {
                  case 7 : 
                      var match = maybe_args[0];
                      var match$1 = called_func[0];
                      if (match.tag) {
                        var match$2 = match[0];
                        return Curry._1(cb, /* tuple */[
                                    /* Error */Block.__(1, [/* tuple */[
                        ...
                        var state = maybe_args[1];
                        var arg_to_node_map = create_lambda_arg_map(match$1[/* vararg */2], match$1[/* args */1], match[0], Common.StringMap[/* empty */0]);
                        if (arg_to_node_map.tag) {
                          return Curry._1(cb, /* tuple */[
                                      Curry._1(Common.AST[/* create_exception */0], arg_to_node_map[0]),
                                      state
                                    ]);
                        } else {
                          var scope_map = Curry._2(Common.StringMap[/* map */22], wrap_in_uuid, match$1[/* scope */3]);
                          var scope_map$1 = Curry._3(Common.StringMap[/* add */3], "recur", /* tuple */[
                                /* None */0,
                                /* Uuid */Block.__(0, [match$1[/* recur */4]])
                              ], scope_map);
                          var docarg_map = Curry._2(Common.StringMap[/* map */22], function (x) {
                                return /* tuple */[
                                        /* None */0,
                                        x
                                      ];
                              }, arg_to_node_map[0]);
                          var argsTable = Curry._2(Common.StringMapHelper[/* union */3], docarg_map, scope_map$1);
                          var ctx_001 = /* depth */ctx[/* depth */1] + 1 | 0;
                          var ctx$1 = /* record */[
                            /* argsTable */argsTable,
                            ctx_001
                          ];
                          return $$eval(match$1[/* func */0], ctx$1, state, cb);
                        }
                      }
                      break;
                  case 8 : 
                      var match$3 = maybe_args[0];
                      if (match$3.tag) {
                        var match$4 = match$3[0];
                        return Curry._1(cb, /* tuple */[
                                    /* Error */Block.__(1, [/* tuple */[
                        ...
                        return Curry._4(called_func[0][/* func */0], match$3[0], /* record */[
                                    /* argsTable */ctx[/* argsTable */0],
                                    /* depth */ctx[/* depth */1] + 1 | 0
                                  ], maybe_args[1], cb);
                      }
                      break;
                  default:
...
function eval_args(func, args, ctx, state, acc, $$return) {
  if (is_macro(func)) {
    return Curry._1($$return, /* tuple */[
                /* Ok */Block.__(0, [args]),
                state
    ...
    var tl = args[1];
    return $$eval(args[0], ctx, state, function (param) {
                var state = param[1];
                var res = param[0];
                if (res.tag) {
                  return Curry._1($$return, /* tuple */[
                  ...
                  return eval_args(func, tl, ctx, state, /* :: */[
                              res[0],
                              acc
                            ], $$return);
                }
...
var Eval = /* module */[
  ...
  /* define_user_symbol */define_user_symbol,
  /* resolve_ident */resolve_ident,
  /* resolve_ident_with_docs */resolve_ident_with_docs,
  /* is_reserved_symbol */is_reserved_symbol,
  /* add_to_uuid_map */add_to_uuid_map,
  /* eval */$$eval,
...
},{"./common.js":4,"./hash.js":6,"./stringify.js":8,"bs-platform/lib/js/block.js":10,"bs-platform/lib/js/caml_builtin_exceptions.js":14,"bs-platform/lib/js/curry.js":32,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/pervasives.js":40}],6:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function hash_hashstring(s) {
  var hash = 0;
  for(var i = 0 ,i_finish = s.length - 1 | 0; i <= i_finish; ++i){
    hash = ((hash << 5) - hash | 0) + Caml_string.get(s, i) | 0;
  }
  return Pervasives.string_of_int(hash);
}

function hashstring_of_func(f) {
  ...
  var scope_list = Curry._3(Common.StringMap[/* fold */10], function (k, param, a) {
        return /* :: */[
                k + param[1],
                a
              ];
      }, f[/* scope */3], /* [] */0);
  var scope = $$String.concat(" ", scope_list);
  return "(" + (kind + (":" + (scope + (":" + (args + (":" + (to_hashstring(f[/* func */0]) + ")")))))));
}

function to_hashstring(ast) {
  switch (ast.tag | 0) {
    case 0 : 
        return ast[0];
    case 1 : 
    ...
    case 6 : 
        return "{" + ($$String.concat("\n", List.map(function (param) {
                          return to_hashstring(param[0]) + (":" + to_hashstring(param[1]));
                        }, Curry._1(Common.ASTMap[/* bindings */16], ast[0]))) + "}");
    case 7 : 
        return hashstring_of_func(ast[0]);
    case 8 : 
        return Pervasives.failwith("Cannot calculate hash of native func");
    
  }
}

function hash(node) {
  return hash_hashstring(to_hashstring(node));
}

exports.hash_hashstring    = hash_hashstring;
exports.hashstring_of_func = hashstring_of_func;
exports.to_hashstring      = to_hashstring;
exports.hash               = hash;
/* Common Not a pure module */

},{"./common.js":4,"bs-platform/lib/js/block.js":10,"bs-platform/lib/js/caml_string.js":26,"bs-platform/lib/js/curry.js":32,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/pervasives.js":40,"bs-platform/lib/js/printf.js":41,"bs-platform/lib/js/string.js":43}],7:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
    ...
    if (match) {
      ...
      if (c !== 34) {
        if (c !== 92) {
          ...
          var pop_str = pop(stream);
          var match$1 = peek(pop_str);
          if (match$1) {
            var c$1 = match$1[0];
            var exit = 0;
            if (c$1 >= 92) {
            ...
            if (exit === 1) {
              return /* ParseFail */Block.__(1, ["Invalid escape sequence \\" + (append_char("", c$1) + ".")]);
            }
            
          } else {
            return /* ParseFail */Block.__(1, ["Unterminated string."]);
          }
        }
      } else {
...
function parse_ident(_stream, _acc) {
  while(true) {
    var acc = _acc;
    var stream = _stream;
    var match = peek(stream);
    ...
    if (exit === 1) {
      switch (acc) {
        ...
        case "false" : 
            return /* ParseOk */Block.__(0, [/* tuple */[
                        stream,
                        /* Bool */Block.__(3, [/* false */0])
                      ]]);
        case "true" : 
            return /* ParseOk */Block.__(0, [/* tuple */[
                        stream,
                        /* Bool */Block.__(3, [/* true */1])
                      ]]);
        default:
          return /* ParseOk */Block.__(0, [/* tuple */[
                      stream,
                      /* Ident */Block.__(0, [acc])
                    ]]);
      }
    }
...
function parse_num(_stream, _acc) {
  while(true) {
    ...
    if (exit === 1) {
      var num;
      try {
        num = /* Some */[Caml_format.caml_float_of_string(acc)];
      }
      catch (exn){
        num = /* None */0;
      }
      if (num) {
        return /* ParseOk */Block.__(0, [/* tuple */[
                    stream,
                    /* Num */Block.__(2, [num[0]])
                  ]]);
      } else {
        return /* ParseFail */Block.__(1, ["Could not parse number [" + (acc + "].")]);
      }
    }
  ...
  while(true) {
    ...
    if (match) {
      ...
      if (exit === 1) {
        var e = parse(stream);
        if (typeof e === "number") {
          return /* ParseFail */Block.__(1, ["Unterminated list."]);
        } else if (e.tag) {
          return e;
        } else {
          var match$2 = e[0];
...
function parse_multi(s) {
  var _stream = create(s);
  var _acc = /* [] */0;
  while(true) {
    var acc = _acc;
    var stream = _stream;
    var match = peek(stream);
    if (match) {
      var match$1 = parse(stream);
      if (typeof match$1 === "number") {
        return Curry._1(Common.AST[/* create_exception */0], "Unexpected end of input.");
      } else if (match$1.tag) {
        return Curry._1(Common.AST[/* create_exception */0], match$1[0]);
      } else {
        var match$2 = match$1[0];
        _acc = /* :: */[
          match$2[1],
...
function parse_single(s) {
  ...
  if (typeof match === "number") {
    ...
    return Curry._1(Common.AST[/* create_exception */0], match[0]);
  } else {
    var match$1 = match[0];
    var match$2 = peek(trim_comments(match$1[0]));
    if (match$2) {
      return Curry._1(Common.AST[/* create_exception */0], "Unexpected character [" + (append_char("", match$2[0]) + "]."));
    } else {
...
var Parser = /* module */[
  ...
  /* parse_num */parse_num,
  /* pop_newline */pop_newline,
  /* wrap_quote_sugar */wrap_quote_sugar,
  /* parse */parse,
  /* parse_no_leading_whitespace */parse_no_leading_whitespace,
...
},{"./common.js":4,"bs-platform/lib/js/block.js":10,"bs-platform/lib/js/caml_builtin_exceptions.js":14,"bs-platform/lib/js/caml_format.js":18,"bs-platform/lib/js/caml_string.js":26,"bs-platform/lib/js/curry.js":32,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/string.js":43}],8:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function string_of_func(f, state) {
  var kind = f[/* is_macro */5] ? "macro" : "function";
  var match = f[/* vararg */2];
  var arg_list = match ? Pervasives.$at(f[/* args */1], /* :: */[
          "... " + match[0],
  ...
  var args = $$String.concat(", ", arg_list);
  var body = string_of_ast(/* Ok */Block.__(0, [f[/* func */0]]), state);
  return "[" + (kind + (": " + (args + (" => " + (body + "]")))));
}

function string_of_exception(param, state) {
  var lst = param[0];
  return "[Exception of " + (string_of_ast(/* Ok */Block.__(0, [param[1]]), state) + ("]" + (
              List.length(lst) > 0 ? "\nTrace: " + $$String.concat("\n       ", List.rev(lst)) : ""
            )));
}

function string_of_ast(ast, state) {
  if (ast.tag) {
    return string_of_exception(ast[0], state);
  } else {
    var value = ast[0];
    switch (value.tag | 0) {
      case 0 : 
      ...
      case 4 : 
          var match = Curry._2(Common.StringMapHelper[/* get */0], value[0], state[/* refMap */3]);
          var $js;
          if (match) {
            var match$1 = Curry._2(Common.StringMapHelper[/* get */0], match[0], state[/* uuidToNodeMap */2]);
            if (match$1) {
              var x = match$1[0];
              $js = x.tag === 4 ? "[Ref]" : string_of_ast(/* Ok */Block.__(0, [x]), state);
            } else {
              $js = "?";
            }
          } else {
      ...
      case 5 : 
          return "(" + ($$String.concat(" ", List.map(function (v) {
                            return string_of_ast(/* Ok */Block.__(0, [v]), state);
                          }, value[0])) + ")");
      case 6 : 
          return "{" + ($$String.concat("\n ", List.map(function (param) {
                            return string_of_ast(/* Ok */Block.__(0, [param[0]]), state) + (": " + string_of_ast(/* Ok */Block.__(0, [param[1]]), state));
                          }, Curry._1(Common.ASTMap[/* bindings */16], value[0]))) + "}");
      case 7 : 
          return string_of_func(value[0], state);
      case 8 : 
...
exports.string_of_func      = string_of_func;
exports.string_of_exception = string_of_exception;
exports.string_of_ast       = string_of_ast;
/* Common Not a pure module */

},{"./common.js":4,"bs-platform/lib/js/block.js":10,"bs-platform/lib/js/curry.js":32,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/pervasives.js":40,"bs-platform/lib/js/printf.js":41,"bs-platform/lib/js/string.js":43}],9:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":13,"./caml_builtin_exceptions.js":14,"./caml_exceptions.js":16,"./curry.js":32,"./js_exn.js":36}],10:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":12,"./caml_builtin_exceptions.js":14,"./caml_string.js":26,"./curry.js":32,"./pervasives.js":40,"./string.js":43,"./sys.js":44}],12:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./caml_int32.js":19,"./caml_obj.js":25,"./caml_string.js":26,"./char.js":31,"./curry.js":32,"./list.js":37,"./pervasives.js":40}],13:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14}],14:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14}],16:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./caml_int32.js":19,"./caml_int64.js":20,"./caml_utils.js":28,"./curry.js":32}],19:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14}],20:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./caml_int32.js":19,"./caml_obj.js":25,"./caml_utils.js":28}],21:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./curry.js":32,"_process":45}],22:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./caml_obj.js":25}],25:[function(require,module,exports){
'use strict';
...
},{"./block.js":10,"./caml_builtin_exceptions.js":14}],26:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14}],27:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"_process":45}],28:[function(require,module,exports){
'use strict';
...
},{"./block.js":10,"./buffer.js":11,"./bytes.js":12,"./caml_builtin_exceptions.js":14,"./caml_bytes.js":15,"./caml_exceptions.js":16,"./caml_float.js":17,"./caml_format.js":18,"./caml_int32.js":19,"./caml_io.js":21,"./caml_obj.js":25,"./caml_string.js":26,"./camlinternalFormatBasics.js":30,"./char.js":31,"./curry.js":32,"./js_exn.js":36,"./pervasives.js":40,"./string.js":43,"./sys.js":44}],30:[function(require,module,exports){
'use strict';
...
},{"./block.js":10}],31:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./caml_string.js":26}],32:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":13}],33:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./caml_md5.js":22,"./caml_missing_polyfill.js":23,"./caml_string.js":26,"./char.js":31,"./pervasives.js":40,"./string.js":43}],34:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":18,"./caml_obj.js":25}],35:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":18,"./caml_int64.js":20}],36:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":16}],37:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./caml_obj.js":25,"./curry.js":32,"./pervasives.js":40}],38:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./curry.js":32}],39:[function(require,module,exports){
'use strict';
...
},{"./caml_format.js":18,"./caml_obj.js":25,"./sys.js":44}],40:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":14,"./caml_exceptions.js":16,"./caml_format.js":18,"./caml_io.js":21,"./caml_missing_polyfill.js":23,"./caml_obj.js":25,"./caml_string.js":26,"./caml_sys.js":27,"./camlinternalFormatBasics.js":30,"./curry.js":32}],41:[function(require,module,exports){
'use strict';
...
},{"./buffer.js":11,"./camlinternalFormat.js":29,"./curry.js":32,"./pervasives.js":40}],42:[function(require,module,exports){
'use strict';
...
},{"./array.js":9,"./caml_array.js":13,"./caml_builtin_exceptions.js":14,"./caml_int64.js":20,"./caml_string.js":26,"./caml_sys.js":27,"./curry.js":32,"./digest.js":33,"./int32.js":34,"./int64.js":35,"./nativeint.js":39,"./pervasives.js":40}],43:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":12,"./caml_int32.js":19,"./caml_string.js":26,"./list.js":37}],44:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":16,"./caml_sys.js":27}],45:[function(require,module,exports){
