...
function add_builtins(state) {
  var add_native_lambda = function (name, is_macro, func, state) {
    ...
    return Curry._3(Evaluate.Eval[/* define_native_symbol */6], state, name, node);
  };
  ...
  var create_lambda_scope = function (node, map, arg_names, ctx, state) {
    ...
    switch (match.tag | 0) {
      case 0 : 
          var i = match[0];
          var match$1 = Curry._3(Evaluate.Eval[/* resolve_ident */8], i, ctx, state);
          if (match$1) {
            var x = match$1[0];
            var new_state = Curry._2(Evaluate.Eval[/* add_to_uuid_map */10], state, x);
          ...
          if (match$1[1]) {
            ...
            if (arg_names.tag) {
              ...
              if (match$3.tag) {
                ...
                var new_state = Curry._2(Evaluate.Eval[/* add_to_uuid_map */10], match$4[1], node);
                return /* tuple */[
                        /* Ok */Block.__(0, [node]),
                        new_state
                      ];
        ...
        if (args) {
          ...
          if (match) {
            if (match[1]) {
              ...
              var lambda = match[0];
              return Curry._4(Evaluate.Eval[/* eval */11], args[0], ctx, state, function (x) {
                          var match = x[0];
                          if (match.tag) {
                            var ex = match[0];
                            return Curry._4(Evaluate.Eval[/* eval */11], lambda, ctx, x[1], function (param) {
                                        var match = param[0];
                                        if (match.tag) {
                                          ...
                                          if (exit === 1) {
                                            return Curry._6(Evaluate.Eval[/* eval_lambda */12], func, /* :: */[
                                                        ex,
                                                        /* [] */0
          ...
          if (match.tag) {
            ...
            if (match$2) {
              if (match$2[1]) {
                ...
                } else if (Curry._2(Evaluate.Eval[/* is_reserved_symbol */9], state, ident)) {
                  return Curry._4(Evaluate.Eval[/* eval */11], match$2[0], ctx, state, function (e) {
                              var match = e[0];
                              if (match.tag) {
                                ...
                                if (res[/* value */1].tag === 7) {
                                  ...
                                  return Curry._1($$return, /* tuple */[
                                              ...
                                              Curry._3(Evaluate.Eval[/* define_user_symbol */7], e[1], ident, res)
                                            ]);
                                }
                              }
                            });
  ...
  var state$11 = add_native_lambda_async("unquote", /* true */1, function (args, ctx, state, $$return) {
        if (args) {
          if (args[1]) {
            ...
            return Curry._4(Evaluate.Eval[/* eval */11], args[0], ctx, state, $$return);
          }
        } else {
          return Curry._1($$return, received_error(1, args, "unquote", state));
        }
          ...
          if (match$2.tag) {
            ...
            if (match$3) {
              if (match$3[1]) {
                ...
                return Curry._4(Evaluate.Eval[/* eval */11], match$3[0], ctx, state, function (param) {
                            var state = param[1];
                            var res = param[0];
                            if (res.tag) {
                              return Curry._1($$return, /* tuple */[
        ...
        if (match$1.tag) {
          ...
          if (lst$1) {
            if (lst$1[1]) {
              ...
              return Curry._4(Evaluate.Eval[/* eval */11], lst$1[0], ctx, state, $$return);
            }
          } else {
            return Curry._1($$return, received_error(1, lst$1, "unquote", state));
          }
          ...
          if (match) {
            ...
            if (match$1) {
              if (match$1[1]) {
                ...
                return Curry._4(Evaluate.Eval[/* eval */11], args[0], ctx, state, function (evaled_cond) {
                            ...
                            if (match.tag) {
                              ...
                              if (match$1.tag === 3) {
                                if (match$1[0] !== 0) {
                                  return Curry._4(Evaluate.Eval[/* eval */11], consequent, ctx, evaled_cond[1], $$return);
                                } else {
                                  return Curry._4(Evaluate.Eval[/* eval */11], alternate, ctx, evaled_cond[1], $$return);
                                }
                              } else {
                                return Curry._1($$return, /* tuple */[
  ...
  var eval_list = function (lst, state, ctx, $$return) {
    if (lst) {
      var tl = lst[1];
      return Curry._4(Evaluate.Eval[/* eval */11], lst[0], ctx, state, function (param) {
                  var match = param[0];
                  if (match.tag) {
                    return Curry._1($$return, /* Error */Block.__(1, [match[0]]));
                  } else {
                    return eval_list(tl, param[1], ctx, $$return);
                  }
                });
    } else {
  ...
  return add_native_lambda_async("load", /* true */1, function (args, ctx, state, $$return) {
              var exit = 0;
              if (args) {
                var match = args[0][/* value */1];
                if (match.tag === 1) {
                  if (args[1]) {
                    ...
                    var cb = function (text) {
                      var match = Parse.parse_multi(text);
                      if (match.tag) {
                        return Curry._1($$return, /* tuple */[
                                    /* Error */Block.__(1, [match[0]]),
                                    state
                    ...
                    var ic = Pervasives.open_in("lib/" + (name + ".lib"));
                    ...
                    return Curry._1(cb, $$String.concat("", loop(/* [] */0)));
                  }
                } else {
                  exit = 1;
                }
...
},{"./common.js":2,"./evaluate.js":3,"./parse.js":5,"bs-platform/lib/js/block.js":7,"bs-platform/lib/js/caml_builtin_exceptions.js":11,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/pervasives.js":36,"bs-platform/lib/js/string.js":39}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/block.js":7,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/map.js":34,"bs-platform/lib/js/pervasives.js":36,"bs-platform/lib/js/printf.js":37,"bs-platform/lib/js/random.js":38,"bs-platform/lib/js/string.js":39}],3:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
},{"./common.js":2,"bs-platform/lib/js/block.js":7,"bs-platform/lib/js/caml_builtin_exceptions.js":11,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/pervasives.js":36}],4:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
function process_input(in_str, state, cb) {
  ...
  if (e.tag) {
    ...
    return Curry._4(Evaluate.Eval[/* eval */11], e[0], Curry._1(Evaluate.Eval[/* create_initial_context */5], state), state, cb);
  }
}
...
var state = [Builtins.add_builtins(Evaluate.Eval[/* empty */0])];
...
},{"./builtins.js":1,"./common.js":2,"./evaluate.js":3,"./parse.js":5,"bs-platform/lib/js/curry.js":28,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/random.js":38}],5:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.7.4, PLEASE EDIT WITH CARE
'use strict';
...
},{"./common.js":2,"./evaluate.js":3,"bs-platform/lib/js/block.js":7,"bs-platform/lib/js/caml_builtin_exceptions.js":11,"bs-platform/lib/js/caml_format.js":15,"bs-platform/lib/js/caml_string.js":22,"bs-platform/lib/js/list.js":33,"bs-platform/lib/js/pervasives.js":36,"bs-platform/lib/js/string.js":39}],6:[function(require,module,exports){
'use strict';
