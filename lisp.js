...
input_element.onkeydown = function (e) {
  if (e.keyCode === 13) {
    ...
    var match = process_input(in_str, state[0]);
    state[0] = match[1];
    input_element.value = "";
    add_console_element("> " + in_str);
    add_console_element(match[0]);
    return false;
  }
  else {
    return true;
...
},{"./web_Tar__Builtins":2,"./web_Tar__Common":3,"./web_Tar__Evaluate":4,"./web_Tar__Parse":5,"bs-platform/lib/js/curry":28,"bs-platform/lib/js/random":37}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 1.3.2 , PLEASE EDIT WITH CARE
'use strict';
